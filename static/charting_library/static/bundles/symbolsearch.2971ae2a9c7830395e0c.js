webpackJsonp([20], {
  ...
  332: function(t, e, i) {
    ...
    (function(e) {
      ...
      function r(t, e) {
        return (
          e in t || (t[e] = 'bitcoin' === e ? window.t('crypto') : window.t(e)),
          t[e]
        );
      }
      var c = i(61),
        ...
        D = (function() {
          function t(i) {
            ...
            if (
              ((i = i || {}),
              (n =
                !i.dontUseInputParser &&
                e.enabled('symbol_search_parser_mixin') &&
                k()),
              (this._inputParserMixin = n
                ? new SymbolSearchInputParserMixin(this)
                : void 0),
          ...
          function I(t) {
            ...
            return (
              ...
              (a = Math.max(
                0,
                Math.min(o.left + s, $(window).width() - h.outerWidth())
              )),
              h.css('left', a + 'px'),
          ...
          return (
            ...
            (t.registerAutoFocus = function(e) {
              if (
                (e instanceof jQuery && (e = e.data('symbol-search-instance')),
                !(e instanceof t))
              )
                throw new TypeError(
                    ...
                    ? ((d = l.getAttribute('data-root')),
                      ...
                      d
                        ? ((this._state.highlightedItem = null),
                          (this._selectedGroupRoot = d))
                        : ((this._state.highlightedItem = r),
                          this._replaceCurrentSymbol(e)))
                    : (delete this._selectedGroupRoot,
                      this._highlightItem(r, !0, e))));
            }),
            ...
            (t.prototype._onKeyPress = function(t) {
              if (t.keyCode === v.DOWN_ARROW || t.keyCode === v.UP_ARROW) {
                ...
                this._moveSelection(t.keyCode === v.DOWN_ARROW ? 1 : -1),
                  t.preventDefault();
              }
              t.keyCode === v.ENTER &&
                (this._selectedGroupRoot
            ...
            (t.prototype._eventListener = function(t, i) {
              ...
              e.enabled('uppercase_instrument_names') && (c = c.toUpperCase()),
                ...
                this._state.selectionStart !== s &&
                  ((this._state.selectionStart = s), (o = !0)),
                (a = this._limitInputSelectionValue('selectionEnd')),
                this._state.selectionEnd !== a &&
                  ((this._state.selectionEnd = a), (o = !0)),
                ...
                ChartApiInstance.searchSymbols(
                  ...
                  function(t) {
                    e !== (d._state.contextTicker || '') ||
                      i !==
                        (d._state.contextExchange ||
                          d.getExchangeFilter() ||
                          '') ||
                      s !== (d._state.typeFilter || '') ||
                      (s === _.types.QUANDL &&
                        (t = d._processQuandlResponse(t)),
            ...
            (t.prototype._groupContracts = function(t) {
              ...
              for (e = 0; e < t.length; ++e) {
                if (((i = t[e]), i.prefix || Array.isArray(i.contracts)))
                  return t;
                'futures' === i.type
                  ? ((n = a.exec(i.symbol)),
                    n
            ...
            (t.prototype._getElementByItem = function(t) {
              return this._renderedResponse && this.$list
                ? this.$list
                    .get(0)
                    .querySelector(
                      'tr[data-item-ticker="' + (t.ticker || t.full_name) + '"]'
                    )
                : null;
            }),
            ...
            (t.prototype._replaceCurrentSymbol = function(t) {
              ...
              if (s.highlightedItem) {
                if (
                  ...
                  if (
                    ((o = this._inputParserMixin.replaceCurrentSymbol(e)),
                    !o.ok)
                  )
                    return;
                  (i = o.newValue),
                    (n = o.newCaretPos),
                    (s.keepListFor = o.keepListFor);
                } else
            ...
            (t.showDialog = function(e) {
              ...
              if (((e = e || {}), (n = 'Symbol Search'), !b.get(n)))
                return (
                  ...
                  k() &&
                    (e.ignoreInterval ||
                      ((c = t.getInputValueGetter(l)),
                      (u = t.getInputValueSetter(l))),
            ...
            (t.bindToInput = function(i, n) {
              ...
              function l() {
                ...
                if (
                  (m ||
                    ...
                    m.on('click', '*', a),
                    m.on('mousedown', '*', a),
                    'function' == typeof n.onPopupOpen &&
                      n.onPopupOpen(t.popup)),
                  e.enabled('charting_library_base') &&
                    ((i = this._state), i.keepListFor))
                ) {
                  if (!i.highlightedItem)
                    return void delete this._state.keepListFor;
                  (o = i.highlightedItem),
              ...
              return (
                ...
                b &&
                  ...
                  k() &&
                  (n.ignoreInterval ||
                    ((C = t.getInputValueGetter(i.get(0))),
                    (x = t.getInputValueSetter(i.get(0)))),
                  (y = SymbolSearchInputParserMixin.addSpreadActions(
                    b,
                    i.get(0),
                    C,
                    x
                ...
                n.syncWithChartWidget &&
                  ...
                  (h = function(t, e) {
                    return (
                      !e &&
                      (t === u.symbol.value() ||
                        (t === u.seriesShortSymbol.value() || void 0))
                    );
                  }),
                  n.syncOnBlur &&
                    i.on('blur', function() {
            ...
            (function() {
              ...
              (t.resetStoredInterval = function() {
                ...
                (t.detachStoreInterval = function(n) {
                  ...
                  return o
                    ? ((e = o.detached), (i = x(e)), o.rest)
                    : (t.resetStoredInterval(), n);
                }),
  ...
  845: function(t, e, i) {
    ...
    function n(t) {
      ...
      return null === n
        ? 0
        : ((e = n[1] ? n[1].length : 0),
          (i = n[2] ? parseInt(n[2], 0) : 0),
          Math.max(0, e - i));
    }
    function o(t) {
      return (
        (t = Math.abs(t)),
        !Object(d.isInteger)(t) &&
          t > 1 &&
          (t = parseFloat(('' + t).replace(/^.+\./, '0.'))),
        ...
        (o = {
          ...
          showNotice: function(t, e, i) {
            ...
            return (
              ...
              o.modalDialog.find('._tv-dialog-content').html(
                n.render(
              ...
              o.positionDialog(),
              o.applyHandlers(!1, {
                doNotCloseOnBgClickIfShadowbox: s,
          ...
          createModalDialog: function(t, e) {
            ...
            return (
              ...
              o._addMessageCloseButton(
                o.modalDialog.find('._tv-dialog-message')
              ),
              e.noShadowBox && o.modalDialog.addClass('transparent'),
              e.addClass && o.modalDialog.addClass(e.addClass),
              e.width &&
                o.modalDialog.find('._tv-dialog').css({ width: e.width }),
              e.content &&
                o.modalDialog.find('._tv-dialog-content').html(e.content),
              (i = $('.fancybox-overlay')),
              i.length &&
                ((n = i.css('z-index')),
                $('._tv-dialog-shadowbox').css('z-index', n + 1)),
              e.draggable &&
          ...
          _addMessageCloseButton: function(t) {
            ...
            t.append(e),
              $(e).on('click', function() {
                t.animate(
                  {
                    marginTop: o.NOTIFICATION_ANIMATION_START_OFFSET,
                    opacity: 0,
                  },
                  'fast',
                  function() {
          ...
          createDialog: function(t, e) {
            ...
            return o.isOpen(t)
              ? ((i = o.get(t)),
                i.find('._tv-dialog-content').html(''),
                i.data('new', !1),
                i)
              : ((e = e || {}),
              ...
              t
                ? ((a = t.prop('ownerDocument')),
                  ...
                  e && e.top && e.left
                    ...
                    : ((h = Math.round((d - r) / 2) + 'px'),
                      (p = Math.round((u - c) / 2) + 'px')),
                  i.fadeIn
                    ? t
                        .css({ left: h, top: p })
                        .hide()
            ...
            (e = e || {}),
              ...
              e.doNotCloseOnEsc ||
                $(n).bind('keyup.hideDialog', function(e) {
                  if (27 === e.keyCode)
                    return t ? o.destroy(t.data('title')) : o.destroy(), !1;
                }),
          ...
          showMessage: function(t, e, i) {
            ...
            e || (e = $('._tv-dialog')),
              ...
              (a = s.find('.message')),
              i.html
                ? a.html('string' == typeof i.html ? i.html : t)
                : a.text(t),
              a
                .css('width', e.width())
                .toggleClass('selectable', !!i.selectable),
              s
          ...
          isOpen: function(t) {
            for (var e = 0; e < o.dialogs.length; e++)
              if (o.dialogs[e].title === t) return !0;
            return !1;
          },
          get: function(t) {
            for (var e = 0; e < o.dialogs.length; e++)
