        ...
        return (
          ...
          (t.prototype._migrate = function(t, e) {
            ...
            for (i = 0; i < t.length; i++)
              (s = this.favId(t[i])),
                -1 === o.indexOf(s) && (o.push(s), (n[s] = e[t[i]]));
    ...
    (function(e, s) {
      ...
      i(208),
        ...
        (o.prototype.isHidedStudy = function(t) {
          ...
          return (
            this._options.onWidget &&
              (e = 'IchimokuCloud@tv-basicstudies' === t.id),
            (i = !1),
            (s = !1),
        ...
        (o.prototype.prepareLayout = function() {
          ...
          (this._dialog = d({
            ...
            addClass:
              ...
              (this._options.minimized ? 'i-minimized' : ''),
        ...
        (o.prototype.scrollHandler = function() {
          var t, e;
          if (!this._loadMore)
            return void this._w_pages.off('scroll.loadMoreOnEnd');
        ...
        (o.prototype._updateDialogTitleText = function() {
          ...
          if (this._dialog) {
            ...
            (i = this.currentPage()),
              this._dialog.setTitleText(i.data('fullTitle'));
          }
        }),
        ...
        (o.prototype.addEconomyPage = function() {
          var t,
            e,
            i = this.addPage(this._ECONOMY_TAB, {
              withoutTopPadding: !0,
              noFlex: !0,
            }),
            s = p({
          ...
          (this._$economyTabInput = s.$input),
            ...
            i.append(s.$control),
            (e = $(
              '<div class="tv-insert-indicator-dialog__economy-content">'
            )),
            e.append(t.$el),
            i.append(e);
        }),
        ...
        (o.prototype._ensureSelectedItemIsVisible = function() {
          ...
          null !== this._selectedStudy &&
            ...
            e.top - i.top < 0
              ? t.scrollTop(o - n)
              : e.bottom - i.bottom > 0 &&
                t.scrollTop(o - i.height + e.height + n));
        }),
                ...
                if (h._currentAsyncSearchDfd === c) {
                  ...
                  for (
                    ...
                    if (
                      ...
                      (A = this._createItemsGroup(
                        f,
                        this._options.minimized ? '' : $.t(w),
                        n
                      )),
                      o.append(A),
                      (this._selectedStudy = null),
                      ...
                      for (
                        P = this.currentPage().find('.js-study-item'), b = 0;
                        b < P.length;
                        ++b
                      )
        ...
        (o.prototype.addPage = function(t, e) {
          ...
          return (
            ...
            (s = t.toLowerCase()),
            (o = $('<div class="tv-insert-indicator-dialog__page">').data(
              'title',
              s
            )),
        ...
        (o.prototype.show = function(t) {
          ...
          this.init(),
            ...
            this._widget.on(
              ...
              function(t) {
                t.which === m.ESC &&
                  (this._widget.unbind('keyup.hideDialogStudy'), this.hide());
              }.bind(this)
            ),
            this._clearInput(),
            this.loadFavorites(),
                      ...
                      (!(!t.which || t.which <= 32) &&
                        (!/^(input|textarea)$/i.test(t.target.tagName) &&
                          ...
                          !!(
                            ...
                            (this._options.minimized &&
                              !r.enabled('study_dialog_search_control'))
                          ) ||
                            (this._search_input.focus(),
        ...
        (o.prototype._showHideBackButton = function() {
          if (this._dialog && !this._options.minimized) {
            ...
            this._dialog.$el
              ...
              .toggleClass('i-with-back-button', t);
          }
        }),
        ...
        (o.prototype._expandCollapseTabs = function(t, e, i, s) {
          ...
          if (
            ((o = t.find('.tv-insert-indicator-dialog__tabs')),
        ...
        (o.prototype.createStudyListItem = function(t, e) {
          ...
          return (
            ...
            (S =
              v &&
              (y === this._STANDARD_STUDIES_PACKAGE_NAME ||
                y === this._FUNDAMENTAL_PACKAGE_NAME)),
            (C =
              v &&
              [
            ...
            (w =
              v && TVScript.Access.ACCESS_CLOSED_NEEDS_AUTH === t.pine.access),
            ...
            (x = $(
              s.render(P, {
                ...
                withFavorites:
                  r.enabled('items_favoriting') && !this._options.minimized,
              })
            )),
            I ||
              x
        ...
        (o.prototype.insertThisStudy = function(t) {
          if (!t.hasClass('placeholder')) {
            ...
            return r.enabled('graying_disabled_tools_enabled') &&
              ...
              ? void l.emit('onGrayedObjectClicked', {
                  type: 'study',
                  name: e.description,
                })
        ...
        (o.prototype.insertStudy = function(t) {
          ...
          o &&
            ...
            (i = h.replaceWithFullStudyMetaInfoAsync(
              o.model().studiesMetaData(),
              t
            )),
            i.done(
              function(t) {
                  ...
                  s = function(i) {
                    ...
                    c.type || (c.type = 'default'),
                      ...
                      'checkbox' === c.type
                        ...
                        : (e.actions[c.name] = $(
                            t.render(
                              c.template ? c.template : E[c.type] || E._default,
                              c,
                              c
                            )
                          ).appendTo(e.$actions)),
              ...
              },
              {
                ...
                value: function() {
                  for (var t = b.length - 1; t >= 0; t--)
                    b[t].zIndex > this.zIndex &&
                      b[t].setZIndex(b[t].zIndex - 1);
                      ...
                      s.get(0) !== this.$el.get(0) &&
                        ($('>*', this.$el).each(function() {
                          s.get(0) === $(this).get(0) && (i = !1),
                            0 === s.closest('HTML', $(this).get(0)).length &&
                              (i = !1);
                        }),
                        i));
                },
                ...
                value: function(t, e) {
                  return (
                    !e && this.disabledActions.includes(t)
                      ...
                      : e &&
                        this.disabledActions.includes(t) &&
                        (this.disabledActions = s.without(
      ...
      (e.TVPopup = (function(t) {
        function e() {
          ...
          return (
            ...
            (t = r(
              this,
              (e.__proto__ || Object.getPrototypeOf(e)).call(this, l({}, b, i))
            )),
            ...
            t.options.withScroll &&
              ((t.scroll = new g.SidebarCustomScroll(
                t.$scrollWrap,
                t.$scrollWrapInner
              )),
