        ...
        return (
          ...
          (t.prototype.checkScrollArrows = function(t) {
            ...
            void 0 === t && (t = !1),
              ...
              i >= s
                ? e(this._elArrowLeft)
                : (i <= s || this._elScrollWrap.scrollWidth <= n) &&
                  o(this._elArrowLeft, _.Left),
              a - i > 1
                ? e(this._elArrowRight)
                : (i >= a || this._elScrollWrap.scrollWidth <= n) &&
                  o(this._elArrowRight, _.Right);
          }),
          ...
          (t.prototype.updateSlider = function(t, e, o) {
            ...
            this._options.noSlider ||
              ...
              0 === i.clientWidth ||
                ...
                (s =
                  i.offsetLeft + parseInt(n.getPropertyValue('padding-left'))),
          ...
          (t.prototype._findOrCreateElement = function(t, e, o, i) {
            ...
            if (!a)
              if (
                ...
                for (
                  s = Array.prototype.slice.call(e.childNodes), r = 0;
                  r < s.length;
                  r++
                )
                  a.appendChild(s[r]);
                  ...
                  f.IS_RTL && o.reverse(),
                    ...
                    Object(r.lazyVelocity)().then(function() {
                      $.Velocity.animate(e._elScrollWrap, 'scroll', {
                        ...
                        offset: Math.floor(
                          i - s - e._getElWidth(e._elArrowLeft)
                        ),
                        queue: !1,
                      });
                    });
                  ...
                  f.IS_RTL && o.reverse(),
                    ...
                    Object(r.lazyVelocity)().then(function() {
                      $.Velocity.animate(e._elScrollWrap, 'scroll', {
                        ...
                        easing: 'easeInOutCubic',
                        offset: Math.ceil(
                          i - n + e._getElWidth(e._elArrowRight)
                        ),
                        queue: !1,
                      });
                    });
                      ...
                      Object.keys(this._predefines).forEach(function(t) {
                        ...
                        o.forEach(function(e) {
                          if (
                            ...
                            (o === t ||
                              (n._symbolAlias[o] && n._symbolAlias[o] === t)) &&
                              s.attr('checked', !0);
                          }
                        });
                      })));
              ...
              },
              {
                ...
                value: function() {
                  function t(t) {
                    ...
                    setTimeout(function() {
                      if ($(e).is(':checked')) {
                        o.addCompareSymbol(t.data.symbol) ||
                          $(e).attr('checked', !1);
                  ...
                  Object.keys(this._predefines).forEach(function(o) {
                    ...
                    s.find('.js-predefine-checkbox').change({ symbol: o }, t),
                      s.appendTo(n);
                  }),
                    n.appendTo(this.$tab);
                },
      ...
      (e.AddCompareDialog = (function() {
        function t(e) {
          i(this, t),
            ...
            (this._dialog = null),
            (this._compareTab = new s.CompareTab(
              this._chartWidgetCollection,
              this
            )),
            (this._addSymbolTab = new r.AddSymbolTab(
              this._chartWidgetCollection,
              this
            ));
        }
                  ...
                  i = function(o) {
                    ...
                    c.type || (c.type = 'default'),
                      ...
                      'checkbox' === c.type
                        ...
                        : (e.actions[c.name] = $(
                            t.render(
                              c.template ? c.template : S[c.type] || S._default,
                              c,
                              c
                            )
                          ).appendTo(e.$actions)),
        ...
        function e() {
          ...
          return (
            ...
            t.options.withScroll &&
              ((t.scroll = new _.SidebarCustomScroll(
                t.$scrollWrap,
                t.$scrollWrapInner
              )),
