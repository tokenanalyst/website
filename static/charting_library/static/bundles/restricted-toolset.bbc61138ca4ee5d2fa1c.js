webpackJsonp([7, 32], {
  ...
  698: function(e, t, n) {
    ...
    function l(e, t) {
      return (
        void 0 === t && (t = !1),
        { name: ue[e], items: [], mayOmitSeparator: t }
      );
    }
    function c(e) {
      var t = !1;
    ...
    function d() {
      ...
      return {
        ...
        OpenPopup: ye,
        Properties:
          u.enabled('header_settings') && u.enabled('show_chart_property_page')
            ? Se
            : void 0,
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
                  ...
                  w.a,
                  {
                    ...
                    content: e
                      ...
                      : v.createElement(
                          k,
                          null,
                          v.createElement(_.a, { icon: g.SERIES_ICONS[h] })
                        ),
          ...
          return (
            (o._handleClick = function() {
              o.setState({ isActive: !0 }),
                o.context.chartWidgetCollection
          ...
          return (
            ...
            (n._handleClickAdd = function() {
              var e = n.state,
                ...
                i = parseInt(t);
              i === r(i, o) &&
                n.props.onAdd(isNaN(parseInt(o)) ? i + '' + o : i * +o + '');
            }),
        ...
        return (
          ...
          (t.prototype.render = function() {
            ...
            return v.createElement(
              ...
              v.createElement(
                'div',
                { className: ee.add, onClick: this._handleClickAdd },
                te.add
              ),
              v.createElement(
                Z.a,
          ...
          return (
            ...
            (h._handleSelectInterval = function(e) {
              void 0 !== e &&
                ...
                (Object(Q.setLastUsedResolution)(e),
                q.linking.interval.setValue(e));
            }),
            (h._handleClickFavorite = function(e) {
              (e = Object(X.ensureDefined)(e)),
                h._isIntervalFavorite(e)
                  ? h._handleRemoveFavorite(e)
                  : h._handleAddFavorite(e);
            }),
        ...
        return (
          ...
          (t.prototype.render = function() {
            ...
            return (
              ...
              (void 0 !== u ? o.concat(u) : o)
                .filter(Q.isAvailable)
                .forEach(function(e) {
                  return (n[e] = !0);
                }),
              ...
              (r =
                void 0 !== u
                  ? Object(Q.getTranslatedResolutionModel)(u)
                  : null),
              v.createElement(
                k,
                { id: h },
        ...
        return (
          ...
          (t.prototype.componentDidMount = function() {
            ...
            Object(nt.bindToInput)(e, {
              ...
              null !== this._actions &&
                Array.from(this._actions.querySelectorAll('button')).forEach(
                  function(e) {
                    return (e.tabIndex = -1);
                  }
                );
      ...
      (ft = (function(e) {
        ...
        return (
          ...
          (t.prototype.componentWillUnmount = function() {
            if (this.props.isFake)
              this.props.stateSyncEmitter.off('change', this._syncStateChange);
            else {
              var e = this.context,
                t = e.favoriteStudyTemplatesService;
              e.studyTemplates
        ...
        return (
          ...
          (t.prototype.componentDidMount = function() {
            ...
            o
              ...
              : ((e = Object(X.ensureNotNull)(this._ref)),
                rt.findDOMNode(e).appendChild(n));
          }),
          (t.prototype.componentWillUnmount = function() {
            var e = this.props,
              t = e.width;
        ...
        return (
          ...
          (t.prototype.render = function() {
            ...
            return r.createElement(
              ...
              (void 0 !== h || l) &&
                r.createElement('div', { className: b.hint }, h),
              void 0 !== y &&
                r.createElement(
                  'div',
                  {
  ...
  848: function(e, t, n) {
    ...
    function o(e) {
      ...
      return a.createElement(
        ...
        p &&
          u &&
          a.createElement('div', { className: r('js-button-text', f.text) }, u),
        w,
        !p &&
          u &&
          a.createElement('div', { className: r('js-button-text', f.text) }, u)
        ...
        function t() {
          ...
          return (
            ...
            (t._handleClickOutside = function(e) {
              ...
              i && i(e),
                !o ||
                  (void 0 !== a && l.findDOMNode(a).contains(e.target)) ||
                  t._handleClose();
            }),
            t
          );
