webpackJsonp([8, 2, 27], {
      ...
      function i(e) {
        ...
        if (
          ...
          !1 !== e.withScroll &&
            ...
            ).append(c.addClass('tv-dialog__scroll-wrap-inner'))),
          (d = $('<div class="tv-tabbed-dialog">')
            .append(o)
            .append(i)),
          e.customControls &&
            o.find('.js-custom-controls').append(e.customControls),
    ...
    function s(t) {
      ...
      return (
        ...
        (!(e = Object.getPrototypeOf(t)) ||
          ...
          'function' ==
            typeof (i = e.hasOwnProperty('constructor') && e.constructor) &&
        ...
        return (
          (t.prototype.getTabsArray = function() {
            ...
            for (t = [], e = 0; e < i.length; e++)
              (o = i[e]),
                o.classList.contains(this._options.sliderClass) || t.push(o);
            return t;
          }),
          ...
          (t.prototype.checkScrollArrows = function(t) {
            ...
            function o(e, o) {
              if (t)
                return (
                  e.classList.add('i-slided'), void e.setAttribute('style', '')
                );
            ...
            void 0 === t && (t = !1),
              ...
              i >= n
                ? e(this._elArrowLeft)
                : (i <= n || this._elScrollWrap.scrollWidth <= s) &&
                  o(this._elArrowLeft, f.Left),
              a - i > 1
                ? e(this._elArrowRight)
                : (i >= a || this._elScrollWrap.scrollWidth <= s) &&
                  o(this._elArrowRight, f.Right);
          }),
          ...
          (t.prototype.updateSlider = function(t, e, o) {
            ...
            this._options.noSlider ||
              ...
              0 === i.clientWidth ||
                ...
                (n =
                  i.offsetLeft + parseInt(s.getPropertyValue('padding-left'))),
                (a = this._getElWidth(i)),
                (c = i.querySelector('.js-tabs__slider-pos')),
                c &&
                  ((d = window.getComputedStyle(c)),
                  (n +=
                    parseInt(d.getPropertyValue('padding-left')) +
                    c.offsetLeft),
          ...
          (t.prototype.deselect = function(t) {
            ...
            return (
              this._options.activeTabClass &&
                o &&
                o.classList.remove(this._options.activeTabClass),
          ...
          (t.prototype._findOrCreateElement = function(t, e, o, i) {
            ...
            if (!a)
              if (
                ...
                for (
                  n = Array.prototype.slice.call(e.childNodes), r = 0;
                  r < n.length;
                  r++
                )
                  a.appendChild(n[r]);
                  ...
                  _.IS_RTL && o.reverse(),
                    ...
                    Object(r.lazyVelocity)().then(function() {
                      $.Velocity.animate(e._elScrollWrap, 'scroll', {
                        ...
                        offset: Math.floor(
                          i - n - e._getElWidth(e._elArrowLeft)
                        ),
                        queue: !1,
                      });
                    });
                  ...
                  _.IS_RTL && o.reverse(),
                    ...
                    Object(r.lazyVelocity)().then(function() {
                      $.Velocity.animate(e._elScrollWrap, 'scroll', {
                        ...
                        easing: 'easeInOutCubic',
                        offset: Math.ceil(
                          i - s + e._getElWidth(e._elArrowRight)
                        ),
                        queue: !1,
                      });
                    });
    ...
    function i(t, e, o, i) {
      ...
      null !== s
        ...
        : l.loadAllSourcesIcons().then(
            function(t) {
              this._destroyed ||
                (this.setIcons(t), null !== this._items && this._updateView());
            }.bind(this)
          );
    }
  ...
  1190: function(t, e, o) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
        ...
        function t(e) {
          ...
          s(this, t),
            ...
            (e.data('scroll') || i.scroll) &&
              ...
              (this.scroll = new a.SidebarCustomScroll(
                this.$scroll,
                this.$inScroll,
                  ...
                  function() {
                    o.offClickOutside(),
                      $(document).on(
                        ...
                        function() {
                          o.onClickOutside(),
                            $(document).off('mouseup.tv-dropdown-view-scroll');
                        }
                      );
                  }
                )),
        ...
        return (
          n(t, [
            ...
            },
            {
              ...
              value: function() {
                this.scroll &&
                  (this.scroll.updateScrollBar(), this.scroll.scrollToStart());
              },
            },
            {
              key: 'enable',
      ...
      ($.fn.tvDropdown = (0, r.createTvBlockWithInstance)(
        'tv-dropdown',
        function(t) {
          var e =
        ...
        (s.prototype.createTreeNodeItem = function(t, e, o) {
          ...
          return (
            ...
            s.click(
              function(e) {
                e.preventDefault(),
                  this._nodeRemoveCallback && this._nodeRemoveCallback(n, t);
              }.bind(this)
            ),
            n
          );
              ...
              : !t &&
                ...
                c.data('wasScroll') &&
                  ...
                  e.scrollHeight <= e.clientHeight &&
                    (o -= u.getScrollbarWidth()),
                  c
                    .css('padding-right', (o < 0 ? 0 : o) + 'px')
        ...
        this._$wrapper.css('overflow', 'hidden'),
          this._$wrapper
            .on('mouseenter.sidebar-scroll', function() {
              d._bottomFixed ||
                d._dragging ||
                (d._options.alwaysVisible || d._$scrollBar.addClass('active'),
                d._onScroll());
            })
            .on('mouseleave.sidebar-scroll', function() {
              d._bottomFixed ||
                d._dragging ||
                (d._options.alwaysVisible ||
                  d._$scrollBar.removeClass('active'),
                d._onScroll());
            })
      ...
      (i.prototype.isTouch = function() {
        ...
        (i.prototype._onScroll = function(t) {
          ...
          return (
            ...
            this._$shadowBottom &&
              this._$shadowBottom.toggleClass('i-invisible', !!o),
                  ...
                  i = function(o) {
                    ...
                    c.type || (c.type = 'default'),
                      ...
                      'checkbox' === c.type
                        ...
                        : (e.actions[c.name] = $(
                            t.render(
                              c.template ? c.template : I[c.type] || I._default,
                              c,
                              c
                            )
                          ).appendTo(e.$actions)),
              ...
              },
              {
                ...
                value: function() {
                  for (var t = y.length - 1; t >= 0; t--)
                    y[t].zIndex > this.zIndex &&
                      y[t].setZIndex(y[t].zIndex - 1);
                  ...
                  m && m !== this && m.unfocus(),
                    ...
                    setTimeout(function() {
                      C.on('mousedown.tv-dialog-unfocus-' + t._id, function(e) {
                        t.isEventOut(e) &&
                          (t.unfocus(),
                          C.off('mousedown.tv-dialog-unfocus-' + t._id));
                      });
                    }, 20);
                },
              },
      ...
      (e.TVPopup = (function(t) {
        function e() {
          ...
          return (
            ...
            (t = r(
              this,
              (e.__proto__ || Object.getPrototypeOf(e)).call(this, l({}, y, o))
            )),
            (t.$scrollWrap = t.$content.hasClass(m)
              ? t.$content
              : t.$content.find('.' + m)),
            t.$scrollWrap.length
            ...
            t.options.withScroll &&
              ((t.scroll = new f.SidebarCustomScroll(
                t.$scrollWrap,
                t.$scrollWrapInner
              )),
            ...
            },
            {
              ...
              value: function() {
                ...
                t.bottom > p.default.height - 10 &&
                  ((e.top = p.default.height - 10 - t.height),
                  e.top < 10 && (e.top = 10)),
                  t.right > p.default.width - 10 &&
                    ((e.left = p.default.width - 10 - t.width),
                    e.left < 10 && (e.left = 10)),
            ...
            },
            {
              ...
              value: function() {
                var t,
                  ...
                  n =
                    this.options.height &&
                    this.options.height < p.default.height - 20
                      ? this.options.height
                      : p.default.height - 20;
                this.$scrollWrap
                  .css({ height: '' })
