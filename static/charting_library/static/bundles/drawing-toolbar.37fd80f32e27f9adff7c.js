webpackJsonp([5, 30], {
  ...
  1009: function(e, o, t) {
    ...
    t.d(o, 'a', function() {
      ...
      (function(e) {
        ...
        function t() {
          (e.favorites = []),
            Object(l.getJSON)('chart.favoriteDrawings', []).forEach(function(
              o
            ) {
      ...
      (function(e) {
        ...
        function c(o, n) {
          ...
          return (
            ...
            s.favorites.splice(n, 0, o),
            s.saveFavorites(),
            e.favoriteMoved.fire(o, i, n),
            !0)
          );
        }
      ...
      return r.createElement(
        'div',
        {
          className: h(
            ...
            s ? t : '',
            ((o = {}),
            (o['apply-common-tooltip common-tooltip-vertical'] = !!z),
            (o[A.isActive] = s),
            (o[A.isBgFull] = a),
            (o[A.isGrayed] = c),
            (o[A.isHidden] = d),
        ...
        r.createElement(
          ...
          l &&
            ('string' == typeof l
              ? r.createElement(T.a, { className: A.icon, icon: l })
              : r.createElement('span', { className: A.icon }, l)),
          n
        )
      );
    }
    ...
    function l(e) {
      return r.createElement(
        'svg',
        {
          ...
          className: h(
            ne.container,
            'right' === e.direction ? ne.mirror : null
          ),
        },
        r.createElement(
          'g',
    ...
    Object.defineProperty(o, '__esModule', { value: !0 }),
      ...
      (m = (function() {
        ...
        return (
          (e.prototype.isToolEnabled = function(e) {
            ...
            return (
              !(!o || !o.grayed) ||
              ('black' === this._drawingsAccess.type ? !o : !!o)
            );
          }),
      ...
      (C = (function(e) {
        function o(o) {
          ...
          return (
            ...
            (t._handleScrollTop = function() {
              t.animateTo(
                Math.max(0, t.currentPosition() - (t.state.heightWrap - 50))
              );
            }),
            (t._handleScrollBot = function() {
              t.animateTo(
                Math.min(
                  (t.state.heightContent || 0) - (t.state.heightWrap || 0),
                  t.currentPosition() + (t.state.heightWrap - 50)
                )
              );
            }),
            (t._handleResizeWrap = function(e) {
              var o = e.height;
              t.setState({ heightWrap: o });
            }),
            (t._handleResizeContent = function(e) {
              var o = e.height;
              t.setState({ heightContent: o });
            }),
            ...
            (t._checkButtonsVisibility = function() {
              var e, o, n, i, l;
              (t.props.isVisibleButtons || t.props.isVisibleFade) &&
                ((e = t.state),
                ...
                (l = t.isAtBot()),
                i || o
                  ? i && o && t.setState({ isVisibleTopButton: !1 })
                  : t.setState({ isVisibleTopButton: !0 }),
                l || n
                  ? l && n && t.setState({ isVisibleBotButton: !1 })
                  : t.setState({ isVisibleBotButton: !0 }));
            }),
            (t.state = {
              heightContent: 0,
              heightWrap: 0,
        ...
        return (
          ...
          (o.prototype.componentDidUpdate = function(e, o) {
            (o.heightWrap === this.state.heightWrap &&
              o.heightContent === this.state.heightContent) ||
              this._handleScroll();
          }),
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement('div', { className: x.content }, a)
                  )
                ),
                d &&
                  r.createElement('div', {
                ...
                p &&
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement(T.a, { icon: y, className: x.icon })
                    )
                  ),
                p &&
                  r.createElement(
          ...
          (o.defaultProps = { isVisibleScrollbar: !0 }),
          o
        );
      })(r.PureComponent)),
      (_ = t(852)),
      ...
      (P = (function(e) {
        function o(o) {
          var t = e.call(this, o) || this;
          return (
            (t._toggleDropdown = function(e) {
              t.setState({ isOpened: void 0 !== e ? e : !t.state.isOpened });
            }),
            (t._handleClose = function() {
              t._toggleDropdown(!1);
            }),
            (t._getDropdownPosition = function() {
              if (!t._control) return { x: 0, y: 0 };
            ...
            (t._handleTouchStart = function() {
              t.props.onClickButton(), t._toggleDropdown();
            }),
            (t._handlePressStart = function() {
              if (Modernizr.touch) t._longPressDelay || t.props.onClickButton();
              else {
                if (t._doubleClickDelay)
                  return (
                    clearTimeout(t._doubleClickDelay),
              ...
              t._longPressDelay = setTimeout(function() {
                delete t._longPressDelay, t._toggleDropdown(!0);
              }, 300);
            }),
            (t._handlePressEnd = function() {
              t._longPressDelay &&
                (clearTimeout(t._longPressDelay),
            ...
            return r.createElement(
              'div',
              {
                className: h(
                  D.dropdown,
                  ((e = {}),
                  (e['apply-common-tooltip common-tooltip-vertical'] = !!a),
                  (e[D.isGrayed] = v),
                  (e[D.isActive] = p),
                  (e[D.isOpened] = u),
                  e)
              ...
              r.createElement(
                ...
                r.createElement(
                  'div',
                  {
                    ...
                    onMouseDown:
                      v || Modernizr.touch ? void 0 : this._handlePressStart,
                    onMouseUp:
                      v || Modernizr.touch ? void 0 : this._handlePressEnd,
                    onClick:
                      !v && Modernizr.touch ? this._handleTouchStart : void 0,
                  },
                  r.createElement(n, {
                    activeClass: i,
                    className: l,
                ...
                !v &&
                  ...
                  r.createElement(
                    'div',
                    { className: D.arrow, onClick: this._handleClickArrow },
                    r.createElement(T.a, { className: D.arrowIcon, icon: I })
                  )
              ),
              !v &&
                r.createElement(
        ...
        function o(o) {
          ...
          return (
            ...
            (t._onChangeDrawingState = function() {
              t.setState({ isActive: t._isActive() });
            }),
            (t._handleSelect = function(e) {
              var o, n;
              Object(k.saveDefaults)(
                'linetoolicon',
                s.a({}, Object(k.defaults)('linetoolicon'), { icon: e })
              ),
                ...
                t.setState({ current: e, recents: o });
            }),
            (t.state = {
          ...
          (o.prototype.render = function() {
            ...
            return r.createElement(
              ...
              a && [
                r.createElement(
                  'div',
                  { key: 'recent', className: R.wrap },
                  a.map(this._renderItem)
                ),
                r.createElement(F.a, { key: 'separator' }),
              ],
              r.createElement(
                'div',
                { key: 'all', className: R.wrap },
        ...
        function o(o) {
          ...
          return (
            (t._handleClick = function() {
              t.props.saveDefaultOnChange &&
                Object(H.saveDefaultProperties)(!0),
                t.props.property.setValue(!t.props.property.value()),
                t.props.saveDefaultOnChange &&
                  Object(H.saveDefaultProperties)(!1);
            }),
            (t.state = {
        ...
        function o(o) {
          ...
          return (
            ...
            (t._onChange = function() {
              t.setState({ isActive: v.tool.value() === t.props.toolName });
            }),
            (t.state = { isActive: v.tool.value() === t.props.toolName }),
            t
          );
        }
        return (
        ...
        return (
          ...
          (o.prototype.render = function() {
            ...
            return r.createElement(
              ...
              {
                transitionName: { enter: o, enterActive: n, leave: l },
                transitionEnter: !0,
                transitionEnterTimeout: b.dur / 2,
                transitionLeave: !0,
                transitionLeaveTimeout: 0.75 * b.dur,
              },
              this.props.isVisible &&
                r.createElement(
                  'div',
                  { key: 'button', className: a },
                  this.props.children
                )
            );
          }),
                ...
                ? (t._boundUndoModel !== o &&
                    (t._boundUndoModel &&
                      t._boundUndoModel
                        .zoomStack()
                        .onChange()
                        .unsubscribe(null, t._syncUnzoomButton),
                    o
                      .zoomStack()
                      .onChange()
                      .subscribe(null, t._syncUnzoomButton),
                    (t._boundUndoModel = o)),
                  (n = !o.zoomStack().isEmpty()))
                : e.withModel(null, t._syncUnzoomButton),
                t.setState({ isVisible: n });
            }),
            (t.state = { isVisible: !1 }),
            t
          );
        ...
        return (
          ...
          (o.prototype.componentDidUpdate = function(e) {
            (this.props.keys === e.keys && this.props.handler === e.handler) ||
              (X.unbind(e.keys), X.bind(this.props.keys, this.props.handler));
          }),
          (o.prototype.componentWillUnmount = function() {
      ...
      (ee = (function(e) {
          ...
          return (
            ...
            (n._handleClickFavorite = function(e) {
              n.state.favState && n.state.favState[e]
                ? J.a.removeFavorite(e)
                : J.a.addFavorite(e);
            }),
            (n._onAddFavorite = function(e) {
              var o;
              n.setState({
                favState: s.a({}, n.state.favState, ((o = {}), (o[e] = !0), o)),
              });
            }),
            (n._onRemoveFavorite = function(e) {
              var o;
              n.setState({
                favState: s.a({}, n.state.favState, ((o = {}), (o[e] = !1), o)),
              });
            }),
        ...
        return (
            ...
            return r.createElement(
              ...
              i.map(function(o, t) {
                ...
                return (
                  ...
                  r.createElement($, {
                    handler: function(o) {
                      o.preventDefault(), e._handleShortcut(n);
                    },
                    key: n,
                    keys: i.keys,
                  })
          ...
          (o.prototype._composeFavState = function() {
            var e = {};
            return (
              this.props.lineTools.forEach(function(o) {
      ...
      (te = (function(e) {
        function o() {
          ...
          return (
            (o._handleRemoveDrawings = function() {
              o.props.chartWidgetCollection.activeChartWidget
                .value()
        ...
        function o(o) {
          ...
          return (
            ...
            (t._handleChangeVisibility = function(e) {
              t.setState({ isVisible: e });
            }),
            (t._toggleVisibility = function() {
              f.isDrawingToolbarVisible.setValue(
                !f.isDrawingToolbarVisible.value()
              );
            }),
            (t._handleEsc = function() {
              v.resetToCursor(!0), Object(N.b)();
            }),
            v.init(),
            (t._toolsFilter = new m(t.props.drawingsAccess)),
            (t._filteredLineTools = w
              .map(function(e) {
                return e.filter(function(e) {
                  return t._toolsFilter.isToolEnabled(
            ...
            t._filteredLineTools.forEach(function(e) {
              return e.forEach(function(e) {
                t._grayedTools[e.name] = t._toolsFilter.isToolGrayed(
                  g.a[e.name].localizedName
                );
              });
            }),
            (t.state = { isVisible: f.isDrawingToolbarVisible.value() }),
            (t._features = {
        ...
        return (
          ...
          (o.prototype.componentDidMount = function() {
            f.isDrawingToolbarVisible.subscribe(this._handleChangeVisibility),
              c.findDOMNode(this).addEventListener('contextmenu', function(e) {
          ...
          (o.prototype.componentDidUpdate = function(e, o) {
            ...
            t !== o.isVisible &&
              (z.emit('toggle_sidebar', !t),
              d.setValue('ChartDrawingToolbarWidget.visible', t),
          ...
          (o.prototype.render = function() {
            ...
            return r.createElement(
                ...
                r.createElement(
                  ...
                  !a &&
                    r.createElement(
                      'div',
                      { className: se.group, style: d },
                      r.createElement(G, { toolName: 'measure' }),
                      r.createElement(G, { toolName: 'zoom' }),
                      r.createElement(q, { chartWidgetCollection: s })
                    ),
                  !a &&
                    r.createElement(
                      'div',
              ...
              r.createElement(
                ...
                r.createElement(l, { direction: c ? 'left' : 'right' })
              ),
              r.createElement(_.a, {
                keyCode: B.a.Escape,
          ...
          (o.prototype._negotiateResizer = function() {
            this.props.resizerBridge.negotiateWidth(
              this.state.isVisible ? le.b : le.a
            );
          }),
          o
        );
    ...
    t.d(o, 'a', function() {
      ...
      (p = (function(e) {
        function o(o) {
          ...
          return (
            ...
            (t._handleMeasure = function() {
              ...
              t.state.isMeasureValid ||
                ((e = t.props.position),
                (o = Object(a.ensureNotNull)(t._containerRef)),
                ...
                (c = n.height > s),
                c &&
                  ((h = Object(a.ensureNotNull)(t._scrollWrapRef)),
                  (h.style.overflowY = 'scroll'),
                  (n = o.getBoundingClientRect())),
                (d = n.width),
                (p = n.height),
                (v = 'function' == typeof e ? e(d, p) : e),
                (z = 5),
                (u = l - d - 5),
                (g = Object(r.clamp)(v.x, z, Math.max(z, u))),
                (m = 5),
                (w = i - p - 5),
                (f = Object(r.clamp)(v.y, m, Math.max(m, w))),
                t.setState({
                  appearingMenuHeight: c ? s : void 0,
                  appearingMenuWidth: v.overrideWidth,
                  appearingPosition: { x: g, y: f },
                  isMeasureValid: !0,
                }));
            }),
        ...
        return (
          ...
          (o.prototype.componentDidMount = function() {
            this._handleMeasure(), v.subscribe(this, this._handleGlobalClose);
          }),
          ...
          (o.prototype.render = function() {
            ...
            return l.createElement(
              ...
              l.createElement(
                ...
                l.createElement('div', { className: a.menuBox }, t)
              )
            );
          }),
          o
          ...
          (o.prototype.render = function() {
            ...
            return s.createElement(
              ...
              s.createElement(
                ...
                s.createElement('div', { className: L.label }, g)
              ),
              (void 0 !== h || r) &&
                s.createElement('div', { className: L.hint }, h),
              void 0 !== M &&
                s.createElement(
                  'div',
                  {
  ...
  849: function(e, o, t) {
    'use strict';
    function n(e) {
      return i.createElement('div', { className: l.separator });
    }
    var i, l;
    (o.a = n), (i = t(20)), t.n(i), (l = t(881)), t.n(l);
  },
  852: function(e, o, t) {
    'use strict';
    var n, i, l;
  ...
  853: function(e, o, t) {
    ...
    t.d(o, 'a', function() {
      ...
      (i = { keys: ['Shift'], text: window.t('{0} — circle') }),
      (l = { keys: ['Shift'], text: window.t('{0} — square') }),
      (s = {
  ...
  872: function(e, o, t) {
    ...
    function i(e) {
      var o = p(e),
        t = document.getElementById(o);
      d[e] && (d[e] -= 1), t && 0 === d[e] && document.body.removeChild(t);
    }
    var l,
      s = t(1),
      a = (t(127), t(20)),
      ...
      v = (function(e) {
        ...
        return (
          ...
          (o.prototype.componentDidUpdate = function(e) {
            this.props.layerId !== e.layerId &&
              (i(this._layerId), this._rememberLayer()),
              this._renderLayer();
          }),
          (o.prototype.componentWillUnmount = function() {
            r.unmountComponentAtNode(this._layer), i(this._layerId);
          }),
          (o.prototype.render = function() {
            return null;
          }),
          (o.prototype._rememberLayer = function() {
            var e = this.props.layerId,
              o = void 0 === e ? h++ + '' : e;
            (this._layerId = o), (this._layer = n(o));
          }),
    ...
    t.d(o, 'a', function() {
      ...
      (l = (function(e) {
        function o() {
          ...
          return (
            ...
            (o._handleClickOutside = function(e) {
              ...
              i && i(e),
                !n ||
                  (void 0 !== l && r.findDOMNode(l).contains(e.target)) ||
                  o._handleClose();
            }),
            o
          );
        ...
        return (
            ...
            return t
              ? a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      z.a,
                      s.a({}, n, { isOpened: t, onClose: this._handleClose }),
                      o
                    )
                  )
                )
          ...
          (o.defaultProps = { closeOnClickOutside: !0 }),
          o
        );
      })(a.PureComponent));
  },
        ...
        return (
          ...
          (o.prototype.render = function() {
            ...
            return i.createElement('span', {
              ...
              dangerouslySetInnerHTML: { __html: o ? a : r },
              onClick: this._handleClick,
