  ...
  821: function(e, t, i) {
    ...
    function n(e, t) {
      ...
      for (
        ...
        (N = x[P]),
          (T = s(N)),
          b.push(T),
          (i = o.schema).push.apply(i, T.fields);
      if (0 === (y = o.schema.length)) return o;
      for (S = g; S <= v; ++S)
        (j = new Float64Array(y)), j.fill(NaN), o.data.push(j);
      if (n.includeTime)
        for (S = g; S <= v; ++S)
          o.data[S - g][0] = Object(u.ensureNotNull)(d.valueAt(S));
      for (
        n.includeSeries &&
          ((I = f.bars().range(g, v)),
          I.each(function(e, t) {
    ...
    function l(e, t, i, n) {
      var l,
        ...
        r,
        a,
        c = Object(u.ensureNotNull)(
          void 0 !== i ? e.indexOf(i, !0) : e.firstIndex()
        ),
        h = Object(u.ensureNotNull)(
      ...
      for (l = 0, s = t; l < s.length; l++)
        (o = s[l]),
          ...
          null !== (a = o.search(h, f.PlotRowSearchMode.NearestLeft)) &&
            ...
            (m = a.index);
      return (
        Object(u.assert)(p <= m, 'Range must contain at least 1 time point'),
        new d.BarsRange(p, m)
      );
    }
    function s(e) {
      ...
      for (t = 0; t < r.plots.length; ++t) {
        if (((i = r.plots[t]), (n = void 0), (l = ''), Object(h.isLinePlot)(i)))
          n = r.styles[i.id];
