webpackJsonp([18], {
  ...
  700: function(e, t, n) {
    ...
    function a(e) {
      return u.createElement(
        L.a,
        c.a({}, e, { forceInteractive: !0, icon: B })
      );
    }
    function o(e) {
      return u.createElement(
        ...
        [
          e.findIndex(function(e) {
            return (
              u.isValidElement(e) &&
              !!e.key &&
              -1 !== ('' + e.key).indexOf('view-only-badge')
            );
          }),
          e.findIndex(function(e) {
            return (
              u.isValidElement(e) &&
              !!e.key &&
              -1 !== ('' + e.key).indexOf('blue-screenshot')
            );
          }),
          e.findIndex(function(e) {
            return (
    ...
    function s(e) {
      ...
      return (
        Object(E.isOnFeaturePage)() &&
          !y.enabled('charting_library_base') &&
          (t = []),
        y.enabled('widget') &&
          (t = [S.STYLE_BARS, S.STYLE_CANDLES, S.STYLE_AREA]),
        t
      );
    }
    function l(e) {
      return (
        void 0 === e && (e = []),
        Object(Q.mergeResolutions)(
          e,
          y.enabled('star_some_intervals_by_default') ? le : []
        )
      );
    }
    var c,
        ...
        function t(t) {
          ...
          return (
            ...
            (n._handleScrollLeft = function() {
              n.animateTo(
                Math.max(0, n.currentPosition() - (n.state.widthWrap - 50))
              );
            }),
            ...
            (n._handleScroll = function() {
              ...
              e && e(n.currentPosition(), n.isAtLeft(), n.isAtRight()),
        ...
        return (
          ...
          (t.prototype.componentDidUpdate = function(e, t) {
            (t.widthWrap === this.state.widthWrap &&
              ...
              this.props.shouldMeasure &&
                ...
                (this._wrapMeasureRef.measure(),
                this._contentMeasureRef.measure());
          }),
          ...
          (t.prototype.isAtRight = function() {
            return (
              ...
              this.state.widthContent - 1
            );
          }),
          (t.prototype.animateTo = function(e, t) {
            if ((void 0 === t && (t = I.dur), this._scroll)) {
              D.IS_RTL &&
                (e = Object(D.getLTRScrollLeftOffset)(this._scroll, e));
                      ...
                      [
                        ...
                        t.DateRange &&
                          u.createElement(
                            i,
                            { key: 'range' },
                            u.createElement(t.DateRange, null)
                          ),
                        t.Intervals &&
                          1 === w &&
                          u.createElement(
                        ...
                        t.UndoRedo &&
                          ...
                          u.createElement(
                            i,
                            { key: 'undo-redo' },
                            u.createElement(t.UndoRedo, {
                              id: g ? void 0 : H.UndoRedo,
                            })
                          ),
                        t.ScalePercentage &&
                          u.createElement(
                          ...
                          [
                            ...
                            !h &&
                              ...
                              u.createElement(
                                i,
                                { key: 'layout' },
                                u.createElement(t.Layout, {
                                  id: g ? void 0 : H.Layouts,
                                })
                              ),
                            t.SaveLoad &&
                              !(h && z) &&
          ...
          return (
            ...
            (r._features = {
              ...
              allowSymbolSearchSpread:
                y.enabled('header_symbol_search') &&
                !y.enabled('charting_library_base'),
        ...
        return (
          ...
          (t.prototype.componentDidUpdate = function(e, t) {
            var n = this.state,
              ...
              a = n.measureValid;
            i !== t.isVisible &&
              (b.emit('toggle_header', i), this._negotiateResizer()),
          ...
          (t.prototype.addButton = function(e) {
            ...
            return (
              ...
              (t = new U.a(0)),
              (n = $(
                '<div class="apply-common-tooltip ' + re.customButton + '">'
              )[0]),
  ...
  848: function(e, t, n) {
    ...
    function i(e) {
      ...
      return o.createElement(
        ...
        p &&
          h &&
          o.createElement('div', { className: r('js-button-text', v.text) }, h),
        _,
        !p &&
          h &&
          o.createElement('div', { className: r('js-button-text', v.text) }, h)
