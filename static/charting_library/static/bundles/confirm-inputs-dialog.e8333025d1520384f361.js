          ...
          function s(t) {
            return function(e) {
              ...
              if (
                ...
                return e;
              for (
                i = e.slice(0, e.indexOf('$')),
                  o = I._model.model().allStudies(),
                  n = 0;
                n < o.length;
                ++n
              )
          ...
          if ('resolution' === e.type)
            ...
            if ((c = this._study && this._study.isChildStudy())) {
              (u = this._study.source()),
                (d = u.title(!0, null, !0)),
                (p = b.getChildSourceInputTitles(
                  e,
                  this._study.source().metaInfo(),
                  d
                ));
              for (f in r)
                p[f] && (r[f] = 1 === Object.keys(p).length ? d : p[f]);
            }
            if (
            ...
            for (V = $('<select/>'), g = 0; g < e.options.length; g++)
              (M = e.options[g]),
                $("<option value='" + M + "'>" + M + '</option>').appendTo(V);
          else
            (V = $('<input/>')),
              'bool' === e.type
                ...
                function(t, i) {
                  ...
                  this._property.offsets[i.id] &&
                    ...
                    (void 0 !== o.isHidden && o.isHidden.value()) ||
                      ...
                      s.push(u(o.max)),
                      this.bindControl(
                        new g(k, o.val, s, !1, this.model(), 'Undo ' + n)
                      )));
                }.bind(this)
              );
        }),
        ...
        m = $.extend(
          ...
          o = (0, r.createDialog)({
            ...
            isClickOutFn: function(t) {
              ...
              if (e)
                return e[0] !== t.target && !e[0].contains(t.target) && void 0;
            },
            actions: [
              { name: 'apply', type: 'primary', text: $.t('Apply'), key: 13 },
            ],
          }),
          d = o,
      ...
      (p = new c.default({ inputs: n })),
        ...
        Array.prototype.forEach.call(_.find('select'), function(t) {
          ...
          e.hasClass('tv-select-container-fontsize') &&
            (i += ' tv-select-container-fontsize'),
    ...
    (function(t) {
      ...
      function I(t, e, i, o, n, s, r, a) {
        ...
        t.slider({
          ...
          s &&
            ...
            $(s[0]).on('keyup', function(t) {
              parseInt($(this).val()) < l._transformers[0]
                ...
                I.prototype.setValueToProperty.call(
                  l,
          ...
          this._propFrom
            .listeners()
            .subscribe(this, I.prototype.propertyChanged),
      ...
      i(866),
            ...
            : ((t = this._control.val()),
              ...
              1e3 *
                E(
                  this._mainSeries
                    .bars()
                    .valueAt(E(this._mainSeries.bars().lastIndex()) - e)
        ...
        (O.prototype.setValue = function(t) {
          if (!this._control.is(':disabled'))
            return w.prototype.setValue.call(this, t);
        }),
        ...
        (I.prototype.destroy = function() {
          this._propFrom &&
            ...
            (this._propFrom
              .listeners()
              .unsubscribe(this, U.prototype.propertyChanged),
            this._propTo
              .listeners()
              .unsubscribe(this, U.prototype.propertyChanged));
        }),
                  ...
                  o = function(i) {
                    ...
                    h.type || (h.type = 'default'),
                      ...
                      'checkbox' === h.type
                        ...
                        : (e.actions[h.name] = $(
                            t.render(
                              h.template ? h.template : x[h.type] || x._default,
                              h,
                              h
                            )
                          ).appendTo(e.$actions)),
              ...
              },
              {
                ...
                value: function() {
                  for (var t = m.length - 1; t >= 0; t--)
                    m[t].zIndex > this.zIndex &&
                      m[t].setZIndex(m[t].zIndex - 1);
                      ...
                      o.get(0) !== this.$el.get(0) &&
                        ($('>*', this.$el).each(function() {
                          o.get(0) === $(this).get(0) && (i = !1),
                            0 === o.closest('HTML', $(this).get(0)).length &&
                              (i = !1);
                        }),
                        i));
                },
                ...
                value: function(t, e) {
                  return (
                    !e && this.disabledActions.includes(t)
                      ...
                      : e &&
                        this.disabledActions.includes(t) &&
                        (this.disabledActions = o.without(
      ...
      (e.TVPopup = (function(t) {
        function e() {
          ...
          return (
            ...
            (t = r(
              this,
              (e.__proto__ || Object.getPrototypeOf(e)).call(this, l({}, m, i))
            )),
