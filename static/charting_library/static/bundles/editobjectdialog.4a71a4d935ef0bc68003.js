webpackJsonp([17, 27], {
            ...
            return (
              ...
              this._model.readOnly() ||
                ...
                m.widget().each(function(t, e) {
                  ...
                  TradingView.isNaN(r) &&
                    ...
                    (n = $(e).data('layout-tab')),
                    void 0 === n &&
                      (n = s ? p.TabNames.coordinates : p.TabNames.inputs),
                ...
                function t(e) {
                  e._childs &&
                    ...
                    $.each(e._childs, function(i, o) {
                      'percentage' === o
                        ? e.percentage.listeners().fire(e.percentage)
                        : t(e[o]);
                    });
                }
                var e,
              ...
              $(window).bind('keyup.hidePropertyDialog', function(t) {
                13 === t.keyCode &&
                  ...
                  (C._templateButton && C._templateButton.trigger('hide-popup'),
                  C.hide());
              }),
              $('select', P).each(function() {
                var t = $(this),
    ...
    (function(t) {
      ...
      function O(t, e, i, o, n, a, s, r) {
        ...
        t.slider({
          ...
          a &&
            ...
            $(a[0]).on('keyup', function(t) {
              parseInt($(this).val()) < l._transformers[0]
                ...
                O.prototype.setValueToProperty.call(
                  l,
          ...
          this._propFrom
            .listeners()
            .subscribe(this, O.prototype.propertyChanged),
      ...
      i(866),
            ...
            : ((t = this._control.val()),
              ...
              1e3 *
                V(
                  this._mainSeries
                    .bars()
                    .valueAt(V(this._mainSeries.bars().lastIndex()) - e)
        ...
        (P.prototype.setValue = function(t) {
          if (!this._control.is(':disabled'))
            return C.prototype.setValue.call(this, t);
        }),
      ...
      a = function(t, e, o) {
        ...
        (t = $(t)),
          ...
          (u = function(s, u, h) {
            ...
            function v(t) {
              if (p.preventFirstProcessClick)
                return void (p.preventFirstProcessClick = !1);
              var e = $(t.target)
                .parents()
                .andSelf();
            ...
            function _(e, n, s) {
              ...
              return e instanceof a.Group
                ? ((p = $('<div class="charts-popup-group"></div>').appendTo(
                    s
                  )),
                  e.title &&
                    ...
                    e.collapsible &&
                      ...
                      u.on('click', function() {
                        p.toggleClass('collapsed'),
                          'function' == typeof e.onChange &&
                            e.onChange(p.hasClass('collapsed')),
                ...
                : ((d = $('<a class="item">')),
                  ...
                  e.date
                    ...
                    ? (d.append(
                      ...
                      (v = $('<span class="title"></span>').appendTo(d)))
                    : (v = $('<span class="title-expanded"></span>').appendTo(
                        d
                      )),
                  e.html
                    ? v.html(e.html)
                    : v.text(TradingView.clean(e.title, !0) || ''),
                  ...
                  void 0 !== e.counter &&
                    ('function' == typeof e.counter
                      ? ((w = $('<span class="counter"></span>').html(
                          e.counter()
                        )),
                        w.appendTo(d))
            ...
            switch (
              ...
              case 'up':
                'down' === V
                  ...
                  E
                    ? y
                        .css('left', Math.max(k.left + O + w - D, S) + 'px')
                        .css('right', 'auto')
              ...
              case 'left':
                (M = Math.max(M, 4)),
                  'right' === V
                    ? y
                        .css('left', Math.floor(k.left + w + M) + 'px')
                        .css('right', 'auto')
                    : y
                        .css(
                          'left',
                          Math.floor(Math.max(k.left - D - M, S)) + 'px'
                        )
                        .css('right', 'auto'),
                  E
                    ? y.css(
                        'top',
                        Math.floor(Math.max(k.top + O + x - P, S)) + 'px'
                      )
  ...
  850: function(t, e, i) {
    ...
    !(function(s) {
      (n = [i(14), i(80)]),
        (o = s),
        void 0 !== (a = 'function' == typeof o ? o.apply(e, n) : o) &&
          (t.exports = a);
    })(function(t) {
      return (t.ui.keyCode = {
        BACKSPACE: 8,
        ...
        _mouseCapture: function(e) {
          ...
          return (
            ...
            this.handles.each(function(e) {
              ...
              (n > i ||
                (n === i &&
                  (e === c._lastChangedValue || c.values(e) === p.min))) &&
                ((n = i), (a = t(this)), (s = e));
            }),
            !1 !== this._start(e, s) &&
          ...
          this._hasMultipleValues()
            ? this.handles.each(function(o) {
                (i =
                  ...
                  100),
                  (p['horizontal' === l.orientation ? 'left' : 'bottom'] =
                    i + '%'),
                  t(this)
                    .stop(1, 1)
        ...
        (n = {
          ...
          createModalDialog: function(t, e) {
            ...
            return (
              ...
              e.width &&
                n.modalDialog.find('._tv-dialog').css({ width: e.width }),
              e.content &&
                n.modalDialog.find('._tv-dialog-content').html(e.content),
              (i = $('.fancybox-overlay')),
              i.length &&
                ((o = i.css('z-index')),
                $('._tv-dialog-shadowbox').css('z-index', o + 1)),
              e.draggable &&
              ...
              t
                ? ((s = t.prop('ownerDocument')),
                  ...
                  e && e.top && e.left
                    ...
                    : ((h = Math.round((p - l) / 2) + 'px'),
                      (d = Math.round((u - c) / 2) + 'px')),
                  i.fadeIn
                    ? t
                        .css({ left: h, top: d })
                        .hide()
          ...
          showMessage: function(t, e, i) {
            ...
            e || (e = $('._tv-dialog')),
              ...
              (s = a.find('.message')),
              i.html
                ? s.html('string' == typeof i.html ? i.html : t)
                : s.text(t),
              s
                .css('width', e.width())
