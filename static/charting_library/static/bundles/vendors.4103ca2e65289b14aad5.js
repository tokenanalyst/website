!(function(e) {
  ...
  function(e, t, n) {
    ...
    function a() {
      document.body &&
        document.body.dispatchEvent(
          new c.CustomEvent('tradingview-i18next-initialized')
        );
    }
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      window.__tradingviewI18nextInited ||
        ...
        (h = i(d)),
        (d && h) ||
          (console.error('No translation data'), (d = 'en'), (h = i('en'))),
        d && h
          ? ((g = {
  ...
  function(e, t) {
    ...
    function o(e) {
      for (var t in e)
        if (('data' !== t || !_t.isEmptyObject(e[t])) && 'toJSON' !== t)
          return !1;
      return !0;
    }
    function i(e, t, n) {
    ...
    function v(e, t, n) {
      ...
      if (
        ((r = Me(e, t)), (r < 0 || null == r) && (r = e.style[t]), Oe.test(r))
      )
        return r;
    ...
    function b(e) {
      return function(t, n) {
        if (('string' != typeof t && ((n = t), (t = '*')), _t.isFunction(n)))
          for (
            var r, o, i, a = t.toLowerCase().split(Xe), s = 0, u = a.length;
            s < u;
            s++
          )
            (r = a[s]),
    ...
    function w(e, t, n, r, o, i) {
      ...
      for (
        var a, s = e[o], u = 0, l = s ? s.length : 0, c = e === Je;
        u < l && (c || !a);
        u++
      )
        'string' == typeof (a = s[u](t, n, r)) &&
          (!c || i[a]
            ? (a = void 0)
            : (t.dataTypes.unshift(a), (a = w(e, t, n, r, a, i))));
        ...
        n.remove(),
          ('none' !== r && '' !== r) ||
            ...
            (ct && lt.createElement) ||
              ...
              ct.write(
                (_t.support.boxModel ? '<!doctype html>' : '') + '<html><body>'
              ),
              ct.close()),
    ...
    (_t.Callbacks = function(e) {
      ...
      _t.extend({
        ...
        when: function(e) {
          function t(e) {
            return function(t) {
              (r[e] = arguments.length > 1 ? A.call(arguments, 0) : t),
                --s || u.resolveWith(u, r);
            };
          }
          function n(e) {
            return function(t) {
              (a[e] = arguments.length > 1 ? A.call(arguments, 0) : t),
                u.notifyWith(l, a);
            };
          }
      ...
      _t.extend({
        ...
        hasData: function(e) {
          return (
            !!(e = e.nodeType ? _t.cache[e[_t.expando]] : e[_t.expando]) &&
            !o(e)
          );
        },
          ...
          if (_t.acceptData(e)) {
            ...
            if (l[c]) {
              ...
              (n || (delete l[c].data, o(l[c]))) &&
                (_t.support.deleteExpando || !l.setInterval
                  ? delete l[c]
                  : (l[c] = null),
                u &&
        ...
        data: function(e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((c = _t.data(u)),
              1 === u.nodeType && !_t._data(u, 'parsedAttrs'))
            ) {
              for (i = u.attributes, s = i.length; l < s; l++)
                (a = i[l].name),
                  0 === a.indexOf('data-') &&
                    ((a = _t.camelCase(a.substring(5))), r(u, a, c[a]));
      ...
      _t.extend({
        ...
        dequeue: function(e, t) {
          ...
          'inprogress' === r && (r = n.shift()),
            ...
            n.length ||
              (_t.removeData(e, t + 'queue ' + t + '.run', !0),
              i(e, t, 'queue'));
        },
      }),
      _t.fn.extend({
          ...
          for (
            ...
            (r =
              ...
              ((_t.data(i[a], l, void 0, !0) || _t.data(i[a], c, void 0, !0)) &&
                _t.data(i[a], u, _t.Callbacks('once memory'), !0))) &&
              (s++, r.add(n));
      ...
      _t.fn.extend({
        ...
        toggleClass: function(e, t) {
          ...
          return _t.isFunction(e)
            ...
            : this.each(function() {
                if ('string' === n)
                  for (
                    var o, i = 0, a = _t(this), s = t, u = e.split(R);
                    (o = u[i++]);
                  ...
                  ('undefined' !== n && 'boolean' !== n) ||
                    (this.className &&
                      _t._data(this, '__className__', this.className),
                    (this.className =
                      this.className || !1 === e
                        ? ''
                        : _t._data(this, '__className__') || ''));
              });
        },
        hasClass: function(e) {
        ...
        val: function(e) {
            ...
            o = this[0];
          {
            ...
            if (o)
              return (t =
                _t.valHooks[o.type] || _t.valHooks[o.nodeName.toLowerCase()]) &&
                'get' in t &&
                void 0 !== (n = t.get(o, 'value'))
                ? n
                : ((n = o.value),
                  'string' == typeof n ? n.replace(F, '') : null == n ? '' : n);
          }
        },
      }),
      _t.extend({
            ...
            get: function(e) {
              ...
              for (n = u ? i : 0, r = u ? i + 1 : s.length; n < r; n++)
                if (
                  ((o = s[n]),
                  o.selected &&
                    (_t.support.optDisabled
                      ? !o.disabled
                      : null === o.getAttribute('disabled')) &&
                    (!o.parentNode.disabled ||
                      !_t.nodeName(o.parentNode, 'optgroup')))
                ) {
          ...
          type: {
            set: function(e, t) {
              if (I.test(e.nodeName) && e.parentNode)
                _t.error("type property can't be changed");
              else if (
                !_t.support.radioValue &&
                'radio' === t &&
                _t.nodeName(e, 'input')
              ) {
                var n = e.value;
      ...
      _t.each(['radio', 'checkbox'], function() {
        _t.valHooks[this] = _t.extend(_t.valHooks[this], {
          set: function(e, t) {
            if (_t.isArray(t))
              return (e.checked = _t.inArray(_t(e).val(), t) >= 0);
          },
        });
      }),
      ...
      (te = function(e) {
        return _t.event.special.hover
          ? e
          : e.replace(X, 'mouseenter$1 mouseleave$1');
      }),
      (_t.event = {
          ...
          if (y && (p = y.events)) {
            for (t = _t.trim(te(t || '')).split(' '), i = 0; i < t.length; i++)
              if (((a = K.exec(t[i]) || []), (s = u = a[1]), (l = a[2]), s)) {
                ...
                0 === g.length &&
                  c !== g.length &&
                  ((d.teardown && !1 !== d.teardown.call(e, l)) ||
                    _t.removeEvent(e, s, y.handle),
                  delete p[s]);
              } else for (s in p) _t.event.remove(e, s + t[i], n, r, !0);
            _t.isEmptyObject(p) &&
              ((h = y.handle),
              h && (h.elem = null),
              _t.removeData(e, ['events', 'handle'], !0));
          }
        },
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ((p = [[n, c.bindType || h]]),
                    !r && !c.noBubble && !_t.isWindow(n))
                  ) {
                    for (
                      d = c.delegateType || h,
                        s = Y.test(d + h) ? n : n.parentNode,
                        u = null;
                      s;
                      s = s.parentNode
                    )
                ...
                for (a in o)
                  o[a].events &&
                    o[a].events[h] &&
                    _t.event.trigger(e, t, o[a].handle.elem, !0);
              }
          }
        },
        dispatch: function(e) {
              ...
              for (
                ...
                (l = s.matches[n]),
                  (h ||
                    ...
                    void 0 !==
                      (i = (
                        (_t.event.special[l.origType] || {}).handle || l.handler
                      ).apply(s.elem, d)) &&
                      ((e.result = i),
        ...
        simulate: function(e, t, n, r) {
          var o = _t.extend(new _t.Event(), n, {
            type: e,
            isSimulated: !0,
            originalEvent: {},
          });
      ...
      _t.each({ mouseenter: 'mouseover', mouseleave: 'mouseout' }, function(
        e,
        t
      ) {
        _t.event.special[e] = {
        ...
        (_t.event.special.submit = {
          setup: function() {
            ...
            _t.event.add(this, 'click._submit keypress._submit', function(e) {
              var t = e.target,
                n =
                  _t.nodeName(t, 'input') || _t.nodeName(t, 'button')
                    ? t.form
                    : void 0;
              n &&
                !n._submit_attached &&
                ...
                ('checkbox' !== this.type && 'radio' !== this.type) ||
                  ...
                  _t.event.add(this, 'click._change', function(e) {
                    this._just_changed &&
                      ...
                      _t.event.simulate('change', this, e, !0));
                  })),
                !1
              );
          ...
          for (s = 0, u = o.length; s < u; s++)
            if ((l = o[s])) {
              for (c = !1, l = l[e]; l; ) {
                ...
                if (1 === l.nodeType)
                  if (
                    (a || ((l[d] = r), (l.sizset = s)), 'string' != typeof t)
                  ) {
                    if (l === t) {
                      c = !0;
                      break;
        ...
        [0, 0].sort(function() {
          ...
          (n = function(e, t, r, a) {
            ...
            do {
              if (
                (p.exec(''),
                (l = p.exec(k)) && ((k = l[3]), _.push(l[1]), l[2]))
              ) {
                h = l[3];
                break;
              }
                    ...
                    for (d = 0; null != (c = y[d]); d++)
                      c &&
                        ...
                        r && null != l
                          ...
                          : h && (m.push(c), (s = !0)));
                  if (void 0 !== l) {
                    if ((r || (y = m), (e = e.replace(o.match[u], '')), !s))
                      return [];
                    break;
                  }
                }
      ...
      _t.fn.extend({
        ...
        has: function(e) {
          ...
          return this.filter(function() {
            for (var e = 0, n = t.length; e < n; e++)
              if (_t.contains(this, t[e])) return !0;
          });
        },
        not: function(e) {
        ...
        closest: function(e, t) {
          ...
          for (
            i =
              se.test(e) || 'string' != typeof e ? _t(e, t || this.context) : 0,
              n = 0,
              r = this.length;
            n < r;
            n++
      ...
      _t.extend({
        ...
        dir: function(e, t, n) {
          for (
            ...
            o &&
            9 !== o.nodeType &&
            (void 0 === n || 1 !== o.nodeType || !_t(o).is(n));
      ...
      _t.fn.extend({
        ...
        empty: function() {
          for (var e, t = 0; null != (e = this[t]); t++)
            for (
              1 === e.nodeType && _t.cleanData(e.getElementsByTagName('*'));
              e.firstChild;
              ...
              if (
                ...
                try {
                  for (; n < r; n++)
                    (t = this[n] || {}),
                      1 === t.nodeType &&
                        (_t.cleanData(t.getElementsByTagName('*')),
                        (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
      ...
      _t.extend({
        ...
        cleanData: function(e) {
          ...
          for (r = 0; null != (o = e[r]); r++)
            if (
              (!o.nodeName || !_t.noData[o.nodeName.toLowerCase()]) &&
              (n = o[_t.expando])
            ) {
              if ((t = a[n]) && t.events) {
                for (i in t.events)
                  s[i] ? _t.event.remove(o, i) : _t.removeEvent(o, i, t.handle);
                t.handle && (t.handle.elem = null);
              }
              u
                ? delete o[_t.expando]
                : o.removeAttribute && o.removeAttribute(_t.expando),
                delete a[n];
            }
        },
      }),
        ...
        style: function(e, t, n, r) {
          if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
            ...
            if (
              ...
              'string' === i &&
                (o = Ne.exec(n)) &&
                ((n = +(o[1] + 1) * +o[2] + parseFloat(_t.css(e, t))),
                (i = 'number')),
              null == n ||
                ('number' === i && isNaN(n)) ||
    ...
    (tt = Qe.exec(et.toLowerCase()) || []),
            ...
            ? ((r = e.indexOf(' ')),
              ...
              t &&
                (_t.isFunction(t)
                  ? ((n = t), (t = void 0))
                  : 'object' == typeof t &&
                    ((t = _t.param(t, _t.ajaxSettings.traditional)),
                    (i = 'POST'))),
              (a = this),
              _t.ajax({
                url: e,
      ...
      _t.extend({
        ...
        ajaxSetup: function(e, t) {
          return (
            t ? x(e, _t.ajaxSettings) : ((t = e), (e = _t.ajaxSettings)),
            x(e, t),
            e
          );
        },
        ...
        ajax: function(e, t) {
          ...
          (v = r.global),
            ...
            r.ifModified &&
              ((l = l || r.url),
              _t.lastModified[l] &&
                x.setRequestHeader('If-Modified-Since', _t.lastModified[l]),
          ...
          if (r.beforeSend && (!1 === r.beforeSend.call(o, x, r) || 2 === y))
            return x.abort(), !1;
      ...
      _t.ajaxPrefilter('json jsonp', function(e, t, n) {
        ...
        if (
          ...
          return (
            (o = e.jsonpCallback = _t.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
            (i = window[o]),
            (a = e.url),
              ...
              send: function(n, r) {
                ...
                a.send((e.hasContent && e.data) || null),
                  ...
                  e.async && 4 !== a.readyState
                    ? ((o = ++at),
                      it &&
                        (st || ((st = {}), _t(window).unload(it)), (st[o] = t)),
            ...
            for (t in e) {
              ...
              !h ||
                ...
                'inline' === _t.css(this, 'display') &&
                  ...
                  (_t.support.inlineBlockNeedsLayout &&
                  'inline' !== P(this.nodeName)
                    ? (this.style.zoom = 1)
      ...
      (_t.fx.prototype = {
        ...
        custom: function(e, t, n) {
          ...
          (this.startTime = gt || S()),
            ...
            (this.unit =
              n || this.unit || (_t.cssNumber[this.prop] ? '' : 'px')),
            ...
            (r.saveState = function() {
              void 0 === _t._data(o.elem, 'fxshow' + o.prop) &&
                (o.options.hide
                  ...
                  : o.options.show &&
                    _t._data(o.elem, 'fxshow' + o.prop, o.end));
            }),
            r() &&
              _t.timers.push(r) &&
              !dt &&
        ...
        hide: function() {
          (this.options.orig[this.prop] =
            _t._data(this.elem, 'fxshow' + this.prop) ||
            _t.style(this.elem, this.prop)),
            (this.options.hide = !0),
        ...
        'getBoundingClientRect' in bt.documentElement
          ? function(e, t, n, r) {
              ...
              var o = t.body,
                ...
                u =
                  i.pageYOffset ||
                  (_t.support.boxModel && n.scrollTop) ||
                  o.scrollTop,
                l =
                  i.pageXOffset ||
                  (_t.support.boxModel && n.scrollLeft) ||
                  o.scrollLeft;
                ...
                (r = a ? a.getComputedStyle(e, null) : e.currentStyle),
                  ...
                  e === o &&
                    ...
                    !_t.support.doesNotAddBorder ||
                      (_t.support.doesAddBorderForTableAndCells &&
                        yt.test(e.nodeName)) ||
      ...
      (_t.fn.offset = function(e) {
        ...
        return n
          ? t === n.body
            ? _t.offset.bodyOffset(t)
            : mt(t, n, n.documentElement)
          : null;
      }),
      (_t.offset = {
      ...
      _t.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, function(
        e,
        t
      ) {
        var n = /Y/.test(t);
            ...
            function(e, r, o) {
              ...
              if (void 0 === o)
                return i
                  ? t in i
                    ? i[t]
                    : (_t.support.boxModel && i.document.documentElement[r]) ||
                      i.document.body[r]
                  : e[r];
              i
                ? i.scrollTo(
    ...
    var r = (window.Modernizr = (function(e, t, n) {
      ...
      return (
        (d.addTest = function(e, t) {
          if ('object' == typeof e)
            for (var r in e) c(e, r) && d.addTest(r, e[r]);
          else {
    ...
    (t = e.exports = function(e, t, n, f, p) {
      ...
      if (i(y)) {
        for (d = s(e.length); d > b; b++)
          if ((m = t ? v(a((h = e[b]))[0], h[1]) : v(e[b])) === l || m === c)
            return m;
      } else
    ...
    (function() {
      ...
      function a(e, t, n) {
        return function(r, o, i) {
          ...
          if (o !== o)
            return (i = t(F.call(r, a, s), $.isNaN)), i >= 0 ? i + a : -1;
      ...
      void 0 !== e && e.exports && (t = e.exports = $),
        ...
        ($.each = $.forEach = function(e, t, n) {
          ...
          if (((t = u(t, n)), g(e)))
            ...
            for (i = $.keys(e), r = 0, o = i.length; r < o; r++)
              t(e[i[r]], i[r], e);
          return e;
        }),
        ...
        ($.find = $.detect = function(e, t, n) {
          var r;
          if (
            void 0 !== (r = g(e) ? $.findIndex(e, t, n) : $.findKey(e, t, n)) &&
            -1 !== r
          )
            return e[r];
        }),
        ...
        ($.every = $.all = function(e, t, n) {
          var r, o, i, a;
          for (
            t = l(t, n), r = !g(e) && $.keys(e), o = (r || e).length, i = 0;
            i < o;
            i++
          )
        ...
        ($.shuffle = function(e) {
          var t,
            ...
            i = Array(o);
          for (t = 0; t < o; t++)
            (n = $.random(0, t)), n !== t && (i[t] = i[n]), (i[n] = r[t]);
          return i;
        }),
        ...
        ($.first = $.head = $.take = function(e, t, n) {
          if (null != e)
            return null == t || n ? e[0] : $.initial(e, e.length - t);
        }),
        ...
        ($.mapObject = function(e, t, n) {
          var r, o, i, a, s;
          for (
            t = l(t, n), r = $.keys(e), o = r.length, i = {}, s = 0;
            s < o;
            s++
          )
            (a = r[s]), (i[a] = t(e[a], a, e));
        ...
        (x = function(e, t, n, r) {
          ...
          if ((n.push(e), r.push(t), i)) {
            ...
            if (((l = $.keys(e)), (u = l.length), $.keys(t).length !== u))
              return !1;
            for (; u--; )
              if (((c = l[u]), !$.has(t, c) || !x(e[c], t[c], n, r))) return !1;
          }
    ...
    !(function(e) {
      ...
      function r(_) {
        ...
        function O(t, n, r) {
          ...
          o.top + f.height > c.height + u.top &&
            (o.top = c.height - f.height + u.top),
        ...
        function N(t) {
          ...
          function v(e) {
            var t = i(e);
            R.css({ top: t + 'px' }),
              (z[2] = l(1 - Math.max(0, Math.min(t, I)) / I)),
              _();
          }
          function b(t) {
            1 == t.which &&
              ((W = !1),
              e(V).unbind('mouseup', b),
              K.is('.opened') &&
                e($)
                  .get(0)
                  .focus());
          ...
          function _() {
            ...
            B &&
              ((B = !1),
              K.find('.tvcolorpicker-swatch.active').removeClass('active')),
              (e = o(p(z), A.val())),
              a(m($.val().toUpperCase()), e) ||
                ((t = h(e)),
                $.data('tvcolorpicker-custom-color', t),
                E.call($, t));
          }
          var k,
            C,
            ...
            X = e('<div class="tvcolorpicker-swatches-area"></div>').appendTo(
              K
            );
          return (
            X.append(
            ...
            M.bind('mousedown', function(t) {
              1 == t.which &&
                ((U = !0), e(V).bind('mouseup', r), n(t), t.preventDefault());
            }),
            ...
            D.bind('mousedown', function(t) {
              1 == t.which &&
                ((W = !0), e(V).bind('mouseup', b), v(t), t.preventDefault());
            }),
    ...
    var r,
      ...
      ee = function(e, t) {
        if (((e = _(e)), (t = k(t, !0)), e !== z || !a(W, t) || a(B, t))) {
          var n = P(e, t);
          return (
            !n || !a(W, t) || (a(e, F) && e[F][t]) || (n.enumerable = !0), n
          );
        }
      },
      te = function(e) {
        ...
        ('__proto__' in {}
          ? (function(e, t, r) {
              try {
                (r = n(55)(
                  Function.call,
                  n(222).f(Object.prototype, '__proto__').set,
                  2
                )),
                  r(e, []),
          ...
          (e.position = {
            ...
            (e.fn.position = function(o) {
              ...
              return (
                ...
                'right' === o.at[0]
                  ? (m.left += d)
                  : 'center' === o.at[0] && (m.left += d / 2),
                'bottom' === o.at[1]
                  ? (m.top += h)
                  : 'center' === o.at[1] && (m.top += h / 2),
                (f = t(_.at, d, h)),
                (m.left += f[0]),
                (m.top += f[1]),
                this.each(function() {
                  ...
                  'right' === o.my[0]
                    ? (E.left -= l)
                    : 'center' === o.my[0] && (E.left -= l / 2),
                    'bottom' === o.my[1]
                      ? (E.top -= c)
                      : 'center' === o.my[1] && (E.top -= c / 2),
                    (E.left += C[0]),
                    (E.top += C[1]),
              ...
              flip: {
                left: function(e, t) {
                  var n,
                    ...
                    h = -2 * t.offset[0];
                  c < 0
                    ? ((n = e.left + p + d + h + t.collisionWidth - s - i) <
                        0 ||
                        n < a(c)) &&
                      (e.left += p + d + h)
                    : f > 0 &&
                ...
                top: function(e, t) {
                  var n,
                    ...
                    g = -2 * t.offset[1];
                  c < 0
                    ? ((r = e.top + d + h + g + t.collisionHeight - s - i) <
                        0 ||
                        r < a(c)) &&
                      (e.top += d + h + g)
                    : f > 0 &&
                      ((n =
                        e.top - t.collisionPosition.marginTop + d + h + g - u) >
                        0 ||
                        a(n) < f) &&
                      (e.top += d + h + g);
                },
    ...
    !(function(n, a) {
      ...
      function u(t, n) {
        ...
        for (
          ...
          if (((N = [C, S, E, b.pos]), u.push(N), '#' === C || '^' === C))
            s.push(N);
          else if ('/' === C) {
            if (!(P = s.pop()))
              throw Error('Unopened section "' + S + '" at ' + E);
            if (P[1] !== S)
              throw Error('Unclosed section "' + P[1] + '" at ' + E);
          } else
            'name' === C || '{' === C || '&' === C
              ? (h = !0)
              : '=' === C && i(S);
        ...
        if ((P = s.pop()))
          throw Error('Unclosed section "' + P[1] + '" at ' + b.pos);
        return c(l(u));
      }
      function l(e) {
        var t,
    ...
    !(function(e, t) {
      ...
      e.extend(n.prototype, {
        ...
        _enableSelectbox: function(t) {
          ...
          (n = e(t.ownerDocument)),
            n
              .find('#sbHolder_' + r.uid)
              .removeClass(r.settings.classHolderDisabled),
            (r.isDisabled = i),
            e.data(t, o, r);
        },
        _disableSelectbox: function(t) {
          ...
          (n = e(t.ownerDocument)),
            n
              .find('#sbHolder_' + r.uid)
              .addClass(r.settings.classHolderDisabled),
            (r.isDisabled = a),
            e.data(t, o, r);
        },
        ...
        _closeSelectbox: function(t) {
          ...
          a &&
            ...
            n
              .find('#sbToggle_' + a.uid)
              .removeClass(a.settings.classToggleOpen),
            n
              .find('#sbHolder_' + a.uid)
              .removeClass(a.settings.classHolderOpen),
            (this._state[a.uid] = i),
            (a.isOpen = i),
  ...
  function(e, t, n) {
    ...
    function s(e, t, n) {
      ...
      if (e && e.defaultProps)
        for (a in (r = e.defaultProps)) void 0 === s[a] && (s[a] = r[a]);
      return {
        $$typeof: M,
        type: e,
        key: u,
  ...
  function(e, t, n) {
    ...
    function a() {
      ...
      if (Dr)
        for (e in Lr)
          if (
            ((t = Lr[e]), (n = Dr.indexOf(e)), -1 < n || r('96', e), !Rr[n])
          ) {
    ...
    function l(e) {
      ...
      for (t in e)
        e.hasOwnProperty(t) &&
          ((n = e[t]),
          (Lr.hasOwnProperty(t) && Lr[t] === n) ||
            (Lr[t] && r('102', t), (Lr[t] = n), (o = !0)));
      o && a();
    }
    function c(e, t, n, r) {
    ...
    function D() {
      ...
      return (
        (so._fallbackText = o.slice(e, 1 < r ? 1 - r : void 0)),
        so._fallbackText
      );
    }
    function L() {
    ...
    function Ue(e) {
      ...
      for (t = 0; t < e.ancestors.length; t++)
        (n = e.ancestors[t]),
          v(e.topLevelType, n, e.nativeEvent, Z(e.nativeEvent));
    }
    function We(e) {
      xi = !!e;
    }
    ...
    function Ve(e) {
      return (
        Object.prototype.hasOwnProperty.call(e, Ei) ||
          ((e[Ei] = Ti++), (ki[e[Ei]] = {})),
        ki[e[Ei]]
      );
    }
    ...
    function yn(e) {
      ...
      function g(r, i, s, u) {
        var l, c, f, g, m, y;
        for (
          l = null, c = null, f = i, g = i = 0, m = null;
          null !== f && g < s.length;
          g++
        ) {
          if (
                  ...
                  if (l.key === c) {
                    if (10 === l.tag ? a.type === Do : l.type === a.type) {
                      n(e, l.sibling),
                        (o = i(
                          l,
                          a.type === Do ? a.props.children : a.props,
                          u
                        )),
                        (o.ref = gn(e, l, a)),
                        (o.return = e),
    ...
    function wn(e) {
      ...
      if (ja)
        if ((t = Pa)) {
          if (((n = t), !bn(e, t))) {
            if (!(t = xt(n)) || !bn(e, t))
              return (e.effectTag |= 2), (ja = !1), void (Na = e);
            vn(Na, n);
          }
          (Na = e), (Pa = _t(t));
    ...
    function Pn(e, t, n) {
      ...
      if (((r = a.value), (t.memoizedProps = a), null === s)) r = 1073741823;
        ...
        if (s.children === a.children && u)
          return (t.stateNode = 0), on(t), jn(e, t);
        r = 0;
      } else if (
        ((o = s.value) === r && (0 !== o || 1 / o == 1 / r)) ||
        (o !== o && r !== r)
      ) {
        if (s.children === a.children && u)
          return (t.stateNode = 0), on(t), jn(e, t);
                ...
                (i = t.memoizedState.element) === o
                  ...
                  : ((o = t.stateNode),
                    (o = (null === e || null === e.child) && o.hydrate) &&
                      ((Pa = _t(t.stateNode.containerInfo)),
                      (Na = t),
                      (o = ja = !0)),
                    o
                      ? ((t.effectTag |= 2), (t.child = Oa(t, null, i, n)))
                      : (kn(), Tn(e, t, i)),
                    (e = t.child)))
              : (kn(), (e = jn(e, t))),
            e
      ...
      for (var t, n, r, o, i, a; ; )
        if (
          ...
          if (
            ((t = Dn(t, e, za)),
            (o = e),
            1073741823 === za || 1073741823 !== o.expirationTime)
          ) {
            switch (((i = 0), o.tag)) {
              case 3:
              case 2:
    ...
    function Qn(e, t) {
      ...
      e: {
        ...
        3 === e.tag &&
          ((n = rn(t, e)), (n = Bn(e, n, 1)), Qt(e, n, 1), Zn(e, 1)),
          (n = void 0);
      }
      return n;
    }
    ...
    function pr(e, t, n) {
      ...
      if (
        null !== I &&
        I._expirationTime <= n &&
        (null === fs ? (fs = [I]) : fs.push(I), I._defer)
      )
      ...
      if (
        ...
        if ('selectionStart' in i)
          a = { start: i.selectionStart, end: i.selectionEnd };
        else
          e: if (
      ...
      for (
        aa = { focusedElem: i, selectionRange: a }, We(!1), Va = o;
        null !== Va;
    ...
    ws || r('227'),
      (Mr = {
        ...
        invokeGuardedCallbackAndCatchFirstError: function(
          ...
          if (
            (Mr.invokeGuardedCallback.apply(this, arguments),
            Mr.hasCaughtError())
          ) {
            var l = Mr.clearCaughtError();
            Mr._hasRethrowError ||
              ((Mr._hasRethrowError = !0), (Mr._rethrowError = l));
          }
        },
        ...
        extractEvents: function(e, t, n, r) {
          ...
          return (
            o
              ...
              : (i = null),
            (e = mo ? B(e, n) : z(e, n))
              ? ((t = fo.getPooled(bo.beforeInput, t, n, r)),
                (t.data = e),
                N(t))
              : (t = null),
      ...
      (Po =
        ws.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED
          .ReactCurrentOwner),
            ...
            function(e) {
              ...
              if (
                ...
                if (0 !== Ri.length && ((e = Mi()), !(-1 === Hi || Hi > e)))
                  for (
                    Hi = -1, $i.didTimeout = !0, t = 0, n = Ri.length;
                    t < n;
                    t++
                  )
                    (r = Ri[t]),
      ...
      (Sr.prototype._onCommit = function() {
        ...
        if (
          ...
          for (t = 0; t < e.length; t++)
            (n = e[t]), 'function' != typeof n && r('191', n), n();
      }),
