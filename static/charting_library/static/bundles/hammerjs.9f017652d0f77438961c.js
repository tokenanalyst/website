webpackJsonp([28], {
  812: function(t, e, n) {
    ...
    !(function(s, r, o, a) {
      ...
      function b(t, e) {
        for (
          var n, i, s = e[0].toUpperCase() + e.slice(1), r = 0;
          r < Ie.length;
      ...
      function M(t) {
        for (var e = [], n = 0; n < t.pointers.length; )
          (e[n] = {
            clientX: be(t.pointers[n].clientX),
            clientY: be(t.pointers[n].clientY),
          }),
            n++;
        return {
          timeStamp: Se(),
      ...
      function j(t, e) {
        var n,
          ...
          h = A(t.touches),
          u = this.targetIds;
        if (e & (Dt | xt) && 1 === h.length)
          return (u[h[0].identifier] = !0), [h, h];
        if (
        ...
        for (n = 0; n < s.length; )
          u[s[n].identifier] && r.push(s[n]),
            e & (wt | Ot) && delete u[s[n].identifier],
            n++;
      ...
      function lt(t, e) {
        return (
          (e = e || {}),
          (e.recognizers = v(e.recognizers, lt.defaults.preset)),
          new pt(t, e)
        );
      }
      function pt(t, e) {
      ...
      (vt =
          ...
          set: function(t) {
            t == se && (t = this.compute()),
              ie &&
                ...
                ce[t] &&
                (this.manager.element.style[ne] = t),
        ...
        (tt.prototype = {
          ...
          requireFailure: function(t) {
            ...
            return (
              (t = it(t, this)),
              -1 === I(e, t) && (e.push(t), t.requireFailure(this)),
              this
            );
          },
          ...
          recognize: function(t) {
            ...
            if (!d(this.options.enable, [this, e]))
              return this.reset(), void (this.state = ge);
        ...
        p(at, tt, {
          ...
          process: function(t) {
            ...
            if (
              ((this._input = t), !i || !n || (t.eventType & (wt | Ot) && !s))
            )
              this.reset();
          ...
          process: function(t) {
            ...
            if (r && o && s) {
              ...
              if (
                ...
                (n =
                  !this.pCenter || Y(this.pCenter, t.center) < i.posThreshold),
            ...
            return u(t, 'remove', this)
              ...
              : ((t = this.get(t)),
                t &&
                  ((e = this.recognizers),
                  -1 !== (n = I(e, t)) &&
                    (e.splice(n, 1), this.touchAction.update())),
                this);
          },
          on: function(t, e) {
            if (t !== a && e !== a) {
