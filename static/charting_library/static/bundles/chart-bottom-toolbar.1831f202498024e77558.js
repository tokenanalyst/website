webpackJsonp([12], {
  ...
  816: function(e, t, n) {
            ...
            (n.prototype.componentDidMount = function() {
              ...
              t.withModel(null, function() {
                ...
                i.onStatusChanged().subscribe(e, e._updateAvailableRanges),
                  ...
                  i
                    .properties()
                    .extendedHours.subscribe(e, e._resetActiveInterval),
    ...
    function d(e) {
      e.updateActions();
      var t = e.actions();
      return t && t.applyTimeZone && t.applyTimeZone.subActions
        ? t.applyTimeZone.subActions
        : [];
    }
    function u(e) {
      return y.createElement('span', {
        className: E(oe.separator, e.className),
      });
    }
    function p(e) {
      var t;
      ...
      return (
        (t = (function(t) {
          ...
          return (
            C.c(n, t),
            (n.prototype.componentDidMount = function() {
              this.context.resizerDetacher.fullscreen.subscribe(
                this._handleLayoutChange
              );
            }),
            (n.prototype.componentWillUnmount = function() {
              this.context.resizerDetacher.fullscreen.unsubscribe(
                this._handleLayoutChange
              );
            }),
            (n.prototype.render = function() {
              ...
              function() {
                ...
                for (t = 0; t < l.length; ++t)
                  if (((n = l[t]), n.containsMainSeries())) {
                    if (((i = []), !(a = n.getDefaultPriceAxisWidget())))
                      return i;
                    for (
                      o = a.getContextMenuActions(), s = 0;
                      s < o.length;
                      ++s
                    )
                      (r = o[s]),
                        r instanceof le.ActionSeparator
                          ...
                          : i.push({
                              action: r.enabled
                                ? r.executeCallback.bind(r)
                                : null,
                              addClass: r.enabled ? '' : 'special',
                              disabled: !r.enabled,
                              iconClass:
                                r.checkable && r.checked
                                  ? 'icon checked-icon'
                                  : 'unchecked-icon',
          ...
          (t.prototype.render = function() {
            ...
            return y.createElement(
              ...
              y.createElement(
                'div',
                {
                  className: fe.seriesControlWrapper,
                  ref: this._handleSeriesControlsRef,
                },
                ...
                y.createElement(
                  ...
                  this.props.logScaleButtonEnabled &&
                    y.createElement(Ce, { className: fe.item }),
                  this.props.autoScaleButtonEnabled &&
                    y.createElement(ye, { className: fe.item }),
          ...
          (t.prototype._handleResize = function() {
            ...
            null === this._raf &&
              (this._raf = requestAnimationFrame(function() {
                ...
                if (
                  (Object.assign(p, { dateRangeMode: S }), 'expanded' !== S)
                ) {
                  for (
                    ...
                    (u = d[c]),
                      ...
                      u.name in Ne
                        ? ((l += u.width),
                          Object.assign(p, ((t = {}), (t[u.name] = !1), t)))
        ...
        function e(e, t, n, i, a, o) {
          ...
          (this._component = null),
            ...
            (s = o.timeFramesWidgetEnabled
              ? o.timeFramesWidget.availableTimeFrames
              : void 0),
            (r = {
        ...
        return (
          ...
          (t.prototype.render = function() {
            ...
            return s.createElement(
              ...
              (void 0 !== d || l) &&
                s.createElement('div', { className: x.hint }, d),
              void 0 !== C &&
                s.createElement(
                  'div',
                  {
                ...
                : ((p = $('<a class="item">')),
                  ...
                  t.date
                    ...
                    ? (p.append(
                      ...
                      (f = $('<span class="title"></span>').appendTo(p)))
                    : (f = $('<span class="title-expanded"></span>').appendTo(
                        p
                      )),
                  t.html
                    ? f.html(t.html)
                    : f.text(TradingView.clean(t.title, !0) || ''),
                  ...
                  void 0 !== t.counter &&
                    ('function' == typeof t.counter
                      ? ((S = $('<span class="counter"></span>').html(
                          t.counter()
                        )),
                        S.appendTo(p))
            ...
            switch (
              ...
              case 'up':
                'down' === A
                  ...
                  D
                    ? _.css('left', Math.max(w.left + W + S - R, T) + 'px').css(
                        'right',
                        'auto'
                      )
              ...
              case 'left':
                (M = Math.max(M, 4)),
                  'right' === A
                    ? _.css('left', Math.floor(w.left + S + M) + 'px').css(
                        'right',
                        'auto'
                      )
                    : _.css(
                        'left',
                        Math.floor(Math.max(w.left - R - M, T)) + 'px'
                      ).css('right', 'auto'),
                  D
                    ? _.css(
                        'top',
                        Math.floor(Math.max(w.top + W + E - N, T)) + 'px'
                      )
  ...
  848: function(e, t, n) {
    ...
    function i(e) {
      ...
      return o.createElement(
        ...
        h &&
          p &&
          o.createElement('div', { className: s('js-button-text', g.text) }, p),
        y,
        !h &&
          p &&
          o.createElement('div', { className: s('js-button-text', g.text) }, p)
        ...
        return (
          ...
          (t.prototype.componentDidUpdate = function(e) {
            this.props.layerId !== e.layerId &&
              (a(this._layerId), this._rememberLayer()),
              this._renderLayer();
          }),
          (t.prototype.componentWillUnmount = function() {
        ...
        function t() {
          ...
          return (
            ...
            (t._handleClickOutside = function(e) {
              ...
              a && a(e),
                !i ||
                  (void 0 !== o && l.findDOMNode(o).contains(e.target)) ||
                  t._handleClose();
            }),
            t
          );
