webpackJsonp([3, 30], {
  ...
  1009: function(t, e, o) {
    ...
    o.d(e, 'a', function() {
      ...
      (function(t) {
        ...
        function i() {
          Object(s.setJSON)('chart.favoriteDrawings', t.favorites);
        }
        (t.favorites = []),
          (t.favoritesSynced = new n.a()),
          (t.favoriteIndex = e),
          (t.saveFavorites = i),
          o(),
          s.onSync.subscribe(null, o);
      })(r || (r = {})),
      (function(t) {
        function e() {
        ...
        function s(e) {
          return (
            ...
            (r.favorites.push(e),
            r.saveFavorites(),
            t.favoriteAdded.fire(e),
            !0)
          );
        }
        function l(e) {
          var o = r.favoriteIndex(e);
          return (
            -1 !== o &&
            (r.favorites.splice(o, 1),
            r.saveFavorites(),
        ...
        function c(e, i) {
          ...
          return (
            ...
            r.favorites.splice(i, 0, e),
            r.saveFavorites(),
            t.favoriteMoved.fire(e, n, i),
            !0)
          );
        }
        (t.favoriteAdded = new n.a()),
          (t.favoriteRemoved = new n.a()),
          (t.favoriteMoved = new n.a()),
          (t.favoritesSynced = r.favoritesSynced),
          (t.favorites = e),
          (t.favoritesCount = o),
          (t.favorite = i),
          (t.addFavorite = s),
  ...
  1039: function(t, e, o) {
    'use strict';
    var i, n, s, r, l, a, c, h, d, p, u, v, g, f, w;
    o.d(e, 'a', function() {
      return w;
    }),
      (i = o(14)),
        ...
        return (
          ...
          (t.prototype.addWidget = function(t, e) {
            ...
            if (
              ...
              throw Error('Index must be in [0, ' + o + ']');
            ...
            Modernizr.touch
              ? ((e = new u.a()),
                e.load().then(function(e) {
                  var i = new e(o._widget);
                  i.get('press').set({ time: 500 }),
                    i.on('press', function(e) {
                      o._preventWidgetTouchEndEvent(), t(e.srcEvent);
                    });
                }))
          ...
          (t.prototype._findWrapperForWidget = function(t) {
            ...
            for (e = 0; e < i.length; ++e)
              if (((o = i.item(e)), o.contains(t))) return o;
            return null;
          }),
          ...
          (t.prototype._updateAxisOption = function() {
            if (this._options.dragOnlyInsideToolbar) {
              ...
              Object(p.lazyJqueryUI)(n()(this._content)).sortable(
                'option',
                'axis',
                t
              );
          ...
          (t.prototype._onWindowResize = function() {
            var t, e;
            'auto' === (this._options.layout || 'auto') &&
              ((t = this._isVertical),
          ...
          (t.prototype._savePosition = function() {
            ...
            Object(l.setJSON)(this._options.positionSettingsKey, {
              left: t.left,
              top: t.top,
            });
          }),
          (t.prototype._init = function() {
            this._loadPosition(),
              Object(p.lazyJqueryUI)(n()(this._widget)).draggable({
                containment: 'window',
          ...
          (t.prototype._getCorrectedWidgetRect = function() {
            var t,
              ...
              o,
              i,
              n = this._widget.getBoundingClientRect();
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (h = (function(t) {
        function e(o) {
          ...
          return (
            (i._onWidgetStateChangedDelegate = new l.a()),
            (i._statedWidgets = []),
        ...
        return (
          ...
          (e.prototype.addGroupedWidget = function(t, o) {
            ...
            void 0 === o && (o = {}),
              ...
              (s = { isEnabled: !0, statedWidget: t, toolbarWidget: i }),
              (r = this._onWidgetClicked.bind(this, s)),
              (s.clickListener = r),
              i.addEventListener('click', r),
              this._updateWidgetPreview(s),
              this.addWidget(i, o),
              this._statedWidgets.push(s);
          }),
          (e.prototype.removeGroupedWidget = function(t) {
            ...
            for (e = 0; e < i; ++e)
              if (((o = this._statedWidgets[e]), o.statedWidget.id === t))
                return (
          ...
          (e.prototype._ensuredGetWidgetDataForId = function(t) {
            ...
            for (e = 0, o = this._statedWidgets; e < o.length; e++)
              if (((i = o[e]), i.statedWidget.id === t)) return i;
          ...
          (e.prototype._createPopup = function(t) {
            ...
            (i.element.className +=
              ...
              t.statedWidget.states.forEach(function(n, s) {
                var r = o._createSubWidget(t, n),
                  l = o._onSubWidgetClicked.bind(o, t, n.id);
                r.addEventListener('click', l),
                  ...
                  r.classList.add(
                    'tv-grouped-floating-toolbar__sub-widget--slide-right-' + s
                  ),
                  r.classList.add(
  ...
  813: function(t, e, o) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      function(t) {
        var i, n, s, r, l, a, c, h, d, p, u, v, g, f, w, m;
            ...
            return (
              ...
              (o.prototype.show = function() {
                this._canBeShownValue.value() &&
                  (u.setValue(o._visibilitySettingsKey, !0),
                  this.isVisible() || this._renderAllLinetools(),
                  e.prototype.show.call(this));
              }),
              (o.prototype.hide = function() {
                u.setValue(o._visibilitySettingsKey, !1),
              ...
              (o.prototype._createLinetoolWidget = function(e) {
                var o = $(
                  t.render(w, {
                    icon: p.a[e].icon,
                    isActive: e === d.tool.value(),
                    title: p.a[e].localizedName,
                  })
                )[0];
                return (
              ...
              (o.prototype._renderAllLinetools = function() {
                ...
                (this._linetoolsWidgets = {}),
                  this.removeWidgets(),
                  a.a.favorites().forEach(function(e) {
                    t.addWidget(t._createLinetoolWidget(e));
                  });
              }),
              (o.prototype._attachHandlers = function() {
                var t = this;
                a.a.favoriteAdded.subscribe(this, this._onFavoriteAdded),
                  a.a.favoriteRemoved.subscribe(this, this._onFavoriteRemoved),
                  a.a.favoriteMoved.subscribe(this, this._onFavoriteMoved),
                  a.a.favoritesSynced.subscribe(null, function() {
                    t._loadVisibilityState(), t._renderAllLinetools();
                  }),
                  this.onWidgetsReordered().subscribe(this, function(e, o) {
                    if (
                      (a.a.favoriteMoved.unsubscribe(t, t._onFavoriteMoved),
                      !a.a.moveFavorite(a.a.favorite(e), o))
                    )
                      throw Error('Something went wrong');
                    a.a.favoriteMoved.subscribe(t, t._onFavoriteMoved);
                  }),
    ...
    (function(e, i) {
      ...
      function s(t, e) {
        t.push({
          id: e,
          widget: $(
            '<div class="tv-linetool-properties-toolbar__text">' + e + '</div>'
          )[0],
        });
      }
      function r(t, e) {
      ...
      o(876),
        ...
        (n.prototype.attachHandlers = function() {
          S.tool.subscribe(this.onToolChanged.bind(this), { callWithLast: !0 }),
            this._chartWidgetCollection.selectedSource.subscribe(
        ...
        (n.prototype._createSourceActions = function() {
          ...
          return (
            e.enabled('property_pages') &&
              t.push({ button: this._createSettingsButton() }),
        ...
        (n.prototype._getZOrderActions = function() {
          var t = [],
            ...
            a = l.getZOrderMinMax();
          return (
            e.zorder() === a.minZOrder &&
              ((n.disabled = !0), (r.disabled = !0)),
            e.zorder() === a.maxZOrder &&
          ...
          if (
            ...
            for (i = {}, n = o.length - 1; n >= 0; --n)
              if (
                ((l = o[n]),
                (a = e[l.name]),
                'function' != typeof (c = l.showIf) || c(a, e))
              ) {
                if (!a) continue;
                if (
                  ((this._propertiesVisible = !0),
                  (h = []),
                  'combobox' !== l.inputType)
                ) {
                ...
                l.simple
                  ...
                  l.propertyProxy &&
                    (a = l.propertyProxy(e, this.activeChartWidget().model())),
                  (i[l.name] = a),
                  a.subscribe(
                    this,
                    this._onPropertyChanged.bind(this, l.name, a)
                  ),
  ...
  823: function(t, e, o) {
    ...
    (function(t) {
      ...
      function v(t, e) {
        return function(o) {
          var i = t();
          return o === e.value() && i && (i.ticker || i.full_name)
            ? i.ticker || i.full_name
            : o;
        };
      }
            ...
            $(s).each(function() {
              $(this).on('keydown', function(t) {
                parseInt($(s[0]).val()) < a._transformers[0]
                  ...
                  : parseInt($(s[1]).val()) > a._transformers[1] &&
                    $(s[1]).val(a._transformers[1]),
      ...
      o(866),
        ...
        (n.prototype.createCombo = function(t) {
          var e = $(document.createElement('select')),
            o = t.reduce(function(t, e) {
              return t.add(
                $(document.createElement('option')).prop({ value: e, text: e })
              );
            }, $());
          return e.append(o);
        }),
        ...
        (n.prototype.createFontEditor = function(t) {
          var e =
            t || TradingView.factoryDefaults('chartproperties.editorFontsList');
        ...
        (n.prototype.createSeriesMinTickEditor = function() {
          ...
          for (t in s)
            (e = s[t]),
              (o = e.priceScale + ',' + e.minMove + ',' + e.frac),
              (i = e.minMove + '/' + e.priceScale),
              (n += "<option value='" + o + "'>" + i + '</option>');
          return (n += '</select>'), $(n);
        }),
        ...
        (n.prototype.createTableInTable = function(t) {
          var e = $('<tr>').appendTo(t),
            o = $('<td>').appendTo(e);
          return $('<table cellpadding="0" cellspacing="0">').appendTo(o);
        }),
        ...
        (n.prototype.addLabeledRow = function(t, e, o, n) {
          var s,
            r = e && e.length > 0 ? $.t(e) : '',
            l = $(document.createElement('tr')),
            a = $(document.createElement('td')).html(r);
          return (
            n && ((n = parseInt(n)), I(n) && (n = 2), a.attr('colspan', n)),
            o && ((s = this._labelToId(e)), o.attr('id', s), a.html(i(r, s))),
            l.append(a).appendTo(t)
          );
        }),
        (n.prototype.addEditorRow = function(t, e, o, i) {
          var n = $(document.createElement('td'));
          return (
            (o.row = this.addLabeledRow(t, e, o, i)),
            o.appendTo(n.appendTo(o.row)),
            o
          );
        }),
        ...
        (n.prototype.addOffsetEditorRow = function(t, e) {
          ...
          return (
            ...
            o.css('width', '100px'),
            o.addClass('ticker'),
            this.addEditorRow(t, e, o)
          );
        }),
        (n.prototype.addFontEditorRow = function(t, e) {
          return this.addEditorRow(t, e, this.createFontEditor());
        }),
        (n.prototype.refreshStateControls = function(t, e, o) {
          var i, n, s;
          for (i = 0; i < e.length; i++) {
            (n = e[i]), (s = t[n.id]);
            try {
              s.toggle(this.parseRule(n.visible, e, o));
            } catch (t) {
              continue;
            }
            s.attr('disabled', !this.parseRule(n.visible, e, o));
          }
        }),
        (n.prototype.parseRule = function(t, e, o) {
          if (!t) return !0;
          var i = t.split('==');
          return !(i.length < 2) && o[i[0]].value() === i[1];
        }),
        ...
        (n.prototype.bindInteger = function(t, e, o, i, n) {
          var s = [a(e.value())];
          void 0 !== i && s.push(r(1)),
            void 0 !== n && s.push(l(1e3)),
            this.bindControl(new g(t, e, s, !1, this.model(), o));
        }),
        (n.prototype.bindColor = function(t, e, o) {
          this.bindControl(new x(t, e, !0, this.model(), o));
        }),
        (n.prototype.bindBoolean = function(t, e, o) {
          this.bindControl(new y(t, e, !0, this.model(), o));
        }),
        inherit(g, j),
        ...
        (g.prototype.setValue = function(t) {
          var e = this._control.val(),
            o = this._formatValue(t);
          e !== o && this._control.val(o);
        }),
        (g.prototype.setValueToProperty = function(t) {
          this._setter
        ...
        inherit(f, g),
        inherit(w, j),
        (w.prototype._forEachSubControl = function(t) {
          this._subControlIds.forEach(function(e) {
            var o = '#' + e,
              i = this.control().find(o);
            t.call(this, i);
          }, this);
        }),
        (w.prototype._parseSessions = function(t) {
          var e,
            o,
            i = t.split('-', 2);
          return (
            ...
            (e = parseInt(i[0])),
            (o = parseInt(i[1])),
            [Math.floor(e / 100), e % 100, Math.floor(o / 100), o % 100]
          );
        }),
        (w.prototype.value = function() {
          ...
          return (
            ...
            (e = [a(0), r(0), l(23)]),
            (o = [a(0), r(0), l(59)]),
            t(i[0], e) + t(i[1], o) + '-' + t(i[2], e) + t(i[3], o)
          );
        }),
        ...
        (m.prototype.setValue = function(t) {
          ...
          return this._disabled || null == t
            ...
            : ((o = A(this._mainSeries.bars().lastIndex())),
              (i = o - e),
              void (this._control.val() !== '' + i && this._control.val(i)));
        }),
        inherit(z, j),
        ...
        (z.prototype._updateDisplayedSymbol = function() {
          ...
          if ((this._control.val(t), this._control.selectbox))
            try {
              (e = this._control.find("[value='" + t + "']")),
                e.length > 0 &&
                  ((o = e[0]),
                  this._control.selectbox('change', o.value, o.text));
            } catch (t) {}
        }),
        (_.prototype.propertyChanged = function(t) {
          var e = t.value();
                    ...
                    .each(function() {
                      ...
                      i.children().each(function() {
                        ...
                        n.is('.ui-slider')
                          ? n.slider(o)
                          : n.is('select')
                          ? (n.selectbox(o), i.css(e))
                          : n.is('.custom-select')
                          ? (n.data(o)(), i.css(e))
                          : n.is('.tvcolorpicker-container')
                          ? (n.find('input').prop('disabled', !t), i.css(e))
                          : (n.prop('disabled', !t), i.css(e));
                      });
                    }))),
        ...
        (y.prototype.destroy = function() {
          j.prototype.destroy.call(this), this._control.off('change');
        }),
        inherit(T, j),
        ...
        (L.prototype.value = function() {
          return this._control.is(':disabled')
            ...
            : y.prototype.value.call(this);
        }),
        (L.prototype.setValue = function(t) {
          if (!this._control.is(':disabled'))
            return y.prototype.setValue.call(this, t);
        }),
        (L.prototype.destroy = function() {
          this._intervalProperty
            ...
            y.prototype.destroy.call(this, arguments);
        }),
        ...
        (k.prototype.destroy = function() {
          this._propFrom &&
            ...
            (this._propFrom
              .listeners()
              .unsubscribe(this, j.prototype.propertyChanged),
            this._propTo
              .listeners()
              .unsubscribe(this, j.prototype.propertyChanged));
        }),
        ...
        (B.prototype.setValue = function(t) {
          ...
          this._control.each(function() {
            var t = $(this),
              o = -1 !== e.indexOf(t.attr('value'));
            t.attr('checked', o), t.parents('label').toggleClass('active', o);
          });
        }),
        (e.PropertyPage = n),
        ...
        (e.ToFloatTransformerWithDynamicDefaultValue = h),
        (e.ToFloatLimitedPrecisionTransformer = d),
        (e.ToAsciiTransformer = p),
        (e.ReplaceEmptyTransformer = u),
        (e.SymbolInfoSymbolTransformer = v),
        (e.SimpleStringBinder = g),
        (e.FloatBinder = f),
        (e.SessionBinder = w),
        (e.BarTimeBinder = m),
        (e.SymbolBinder = z),
        (e.SimpleComboBinder = _),
        (e.StaticContentBinder = M),
        (e.BooleanBinder = y),
        (e.DisabledBinder = T),
        (e.ColorBinding = x),
        (e.SliderBinder = C),
        (e.CheckboxWVBinding = S),
        (e.RangeBinder = k),
        (e.generateLabelElementStr = i);
    }.call(e, o(13)));
  },
  827: function(t, e, o) {
    'use strict';
  ...
  829: function(t, e, o) {
    'use strict';
    function i(t) {
      var e = Object(a.parseRgb)(t),
        o = e.map(function(t) {
          return t > 50 ? t - 50 : 0;
        });
      return Object(a.rgbToString)(o);
    }
    function n(t) {
      var e,
        o,
        i,
        n = [];
      for (e = 0, o = t; e < o.length; e++)
        (i = o[e]), null !== Object(a.tryParseRgb)(i) && n.push(i);
      return n;
    }
    function s(t, e) {
      void 0 === e && (e = {});
      var o = $('<span class="tvcolorpicker-container">');
      return (
        null !== t && o.appendTo(t),
        void 0 !== e.addClass && o.addClass(e.addClass),
        $('<div class="tvcolorpicker-transparency">').appendTo(o),
        $('<input class="colorpicker-widget">')
          ...
          .on('change', function() {
            $(this).css('border-color', i($(this).val() || h));
          })
  ...
  847: function(t, e, o) {
        ...
        (t = $(t)),
          ...
          (d = function(r, d, u) {
            function v(e) {
              ...
              o.is(z) ||
                o.is(t) ||
                o.is('.charts-popup-tab-headers, .charts-popup-itemheader') ||
                c();
            }
            function g(t) {
              if (h.preventFirstProcessClick)
                return void (h.preventFirstProcessClick = !1);
              var e = $(t.target)
                .parents()
                .andSelf();
            ...
            function w(e, n, r) {
              var l, a, c, h, d, p, u, v, g, f, m, _, M, y, T, b;
              if (e instanceof s.TabGroup) {
              ...
              return e instanceof s.Group
                ? ((h = $('<div class="charts-popup-group"></div>').appendTo(
                    r
                  )),
                  e.title &&
                    ...
                    e.collapsible &&
                      (h.addClass('charts-popup-group-collapsible'),
                      h.toggleClass('collapsed', e.collapsed),
                      d.on('click', function() {
                        h.toggleClass('collapsed'),
                          'function' == typeof e.onChange &&
                            e.onChange(h.hasClass('collapsed')),
                          z.height() === parseInt(z.css('max-height'))
                            ? z.addClass('popup-menu-scroll-y')
                            : z.height() < parseInt(z.css('max-height')) &&
                              z.removeClass('popup-menu-scroll-y');
                      })),
                    h.append(d)),
                  void $.each(e.items, function(t) {
                    w(this, 1, h);
                  }))
                : e instanceof s.Header
                ? void r.append(
                ...
                : e.separator
                ? ((p = $('<span class="separator"></span>')), void r.append(p))
                : ((p = $('<a class="item">')),
                  e.url && p.attr('href', e.url),
                  e.target && p.attr('target', e.target),
                  n || p.addClass('first'),
                  'function' == typeof e.active
                    ? e.active(e) && p.addClass('active')
                    : e.active && p.addClass('active'),
                  e.addClass && p.addClass(e.addClass),
                  e.addData && p.data(e.addData),
                  e.disabled && p.addClass('disabled'),
                  'function' == typeof e.action &&
                    ...
                    i.upAction ? p.bind('mouseup', v) : p.bind('click', v)),
                  e.date
                    ? ((g = $('<span class="title"></span>').appendTo(p)),
                      $('<span class="date"></span>')
                        .text(e.date || '')
                        .appendTo(p))
                    : e.icon && !i.svg
                    ? ((f = $('<span class="icon"></span>').appendTo(p)),
                      f.css('background-image', e.icon.image || ''),
                      e.icon.offset &&
                        f.css(
                          'background-position',
                    ...
                    : e.iconClass
                    ? (p.append(
                        $('<span class="icon"></span>').addClass(e.iconClass)
                      ),
                      (g = $('<span class="title"></span>').appendTo(p)))
                    : (g = $('<span class="title-expanded"></span>').appendTo(
                        p
                      )),
                  e.html
                    ? g.html(e.html)
                    : g.text(TradingView.clean(e.title, !0) || ''),
                  (m = $('<span class="shortcut"></span>').appendTo(p)),
                  e.shortcut && m.text(e.shortcut.keys),
                  'function' == typeof e.deleteAction &&
                    ((_ = e.deleteAction),
                    (M = e.deleteAction.title || $.t('Delete')),
                    (y = $('<span class="icon-delete">')),
                    y.html(o(828)),
                    y.attr('title', M),
                    y.on('click', function(t) {
                      _.apply(p, arguments), t.preventDefault();
                    }),
                    p.append(y)),
                  ...
                  void 0 !== e.counter &&
                    ('function' == typeof e.counter
                      ? ((T = $('<span class="counter"></span>').html(
                          e.counter()
                        )),
                        T.appendTo(p))
                      : ((b = e.counterBlue ? 'blue' : ''),
                        $('<span class="counter"></span>')
                          .text(e.counter + '')
                          .addClass(b)
                          .appendTo(p))),
                  r.append(p),
                  void t.data('popup-menu', r));
            }
            var m,
              z,
              _,
            ...
            if (
              ...
              return r.preventDefault(), c(), void (m = h.scrollTop);
            switch (
              ((c = function() {
                (h.scrollTop = z.scrollTop()),
                  z.remove(),
                  t.removeClass('active open ' + i.activeClass),
                  t.data('popup-menu', null),
                  $(G).off('click', g),
                  $(G).off('mousedown', v),
                  Modernizr.touch && $(G).off('touchstart.chartgui', v),
                  $(G).off('selectstart.' + p),
                  G.removeEventListener('keydown', f, !1),
                  (c = a),
                  i.onRemove && i.onRemove();
              }),
              t.addClass('active open ' + i.activeClass),
              (z = $('<div class="charts-popup-list">')),
              i.addClass && z.addClass(i.addClass),
              i.zIndex && z.css('z-index', i.zIndex),
              (_ = z),
              i.listInner && (_ = $('<div class="list-inner">').appendTo(_)),
              i.listTable && (_ = $('<div class="list-table">').appendTo(_)),
              $.each(Z, function(t) {
                w(this, t, _);
              }),
              l || (h.preventFirstProcessClick = !0),
              $(G).on('click', g),
              $(G).on('mousedown', v),
              G.addEventListener('keydown', f, !1),
              Modernizr.touch && $(G).on('touchstart.chartgui', v),
              i.upAction &&
              ...
              z.appendTo(G.body),
              (M = $(U).width()),
              (y = Math.min($(U).height(), $('body').height())),
              (T = t.outerWidth()),
              (b = t.outerHeight()),
              (x = t.offset()),
              (m = $(U).scrollTop() || 0),
              ...
              (C = z.outerWidth()),
              (L = z.outerHeight()),
              (P = void 0 !== i.viewportSpacing ? i.viewportSpacing : 10),
              (S = i.popupSpacing ? ~~i.popupSpacing : 1),
              (k = i.popupDrift ? ~~i.popupDrift : 0),
              (B = L - z.height()),
              (A = 'down'),
              i.direction &&
                (A =
                  'function' == typeof i.direction
                    ? i.direction()
                    : i.direction),
              (I = !!i.reverse),
              'down' === A
                ? ((E = y - x.top - b - S - P - B),
                  (W = x.top - S - P - B),
                  E < Math.max(L || 0, 100) && W > E && (A = 'up'))
                : 'right' === A &&
                  ((V = M - x.left - T - S - P - B),
                  (F = x.left - S - P - B),
                  V < Math.max(C || 0, 100) && F > V && (A = 'left')),
              A)
            ) {
              case 'down':
              case 'up':
                'down' === A
                  ? z.css('top', x.top + b + S + 'px')
                  : z.css('bottom', y - x.top + S + 'px').css('top', 'auto'),
                  I
                    ? z
                        .css('left', Math.max(x.left + k + T - C, P) + 'px')
                        .css('right', 'auto')
                    : z.css('left', x.left + k + 'px').css('right', 'auto');
                break;
              case 'right':
              case 'left':
                (S = Math.max(S, 4)),
                  'right' === A
                    ? z
                        .css('left', Math.floor(x.left + T + S) + 'px')
                        .css('right', 'auto')
                    : z
                        .css(
                          'left',
                          Math.floor(Math.max(x.left - C - S, P)) + 'px'
                        )
                        .css('right', 'auto'),
                  I
                    ? z.css(
                        'top',
                        Math.floor(Math.max(x.top + k + b - L, P)) + 'px'
                      )
                    : z.css('top', Math.floor(x.top + k) + 'px');
            }
            for (
              z.show(),
                D = x.top,
                'up' === A || ({ left: 1, right: 1 }[A] && I)
                  ? 'up' !== A
                    ? (D += b)
                    : (D -= b + S + B + P)
                  : (D = y - D - b - 2 * S - B),
                z.height() > D && z.addClass('popup-menu-scroll-y'),
                z.css('max-height', D + 'px'),
                i.careRightBorder &&
                  ((N = M + $(U).scrollLeft()),
                  parseInt(z.css('left')) + z.width() + P > N &&
                    z
                      .css('left', N - z.width() - P + 'px')
                      .css('right', 'auto')),
                i.careBottomBorder &&
                  parseInt(z.css('top')) + z.height() + P > y + m &&
                  z.css('top', y - z.height() - P + m + 'px'),
                R = t.parents().andSelf(),
                H = R.size();
              H--;

            )
              if ('fixed' === R.eq(H).css('position')) {
                O = R.eq(H);
                break;
              }
            O &&
              ...
              z[0].scrollHeight > z.height() && z.addClass('popup-with-scroll'),
              r && r.preventDefault();
          }),
          r && t.bind(r, d),
          l &&
    ...
    (s.TabGroup = function t(e) {
      ...
      (s.TabGroup.prototype.appendTab = function(t, e, o) {
        if (
          (null == t ? (t = '') : (t += ''),
          e || (e = []),
          o || (o = {}),
        ...
        return this.tabs.push({ name: t, items: e, active: !!o.active }), e;
      }),
  ...
  853: function(t, e, o) {
    ...
    var i,
      ...
      c = {
        ...
        dot: o(994),
        drawginmode: o(995),
        drawginmodeActive: o(996),
        eraser: o(997),
        group: o(998),
        hideAllDrawings: o(885),
        hideAllDrawingsActive: o(999),
        lockAllDrawings: o(1e3),
        lockAllDrawingsActive: o(1001),
        magnet: o(1002),
        measure: o(1003),
        removeAllDrawingTools: o(1004),
        showObjectsTree: o(1005),
        zoom: o(1006),
        'zoom-out': o(1007),
      };
    o.d(e, 'a', function() {
      ...
      (n = { keys: ['Shift'], text: window.t('{0} — circle') }),
      ...
      (r = {
        ...
        arrow: { icon: c.arrow, localizedName: window.t('Arrow') },
        cursor: { icon: c.cursor, localizedName: window.t('Cross') },
        dot: { icon: c.dot, localizedName: window.t('Dot') },
        drawginmode: {
          icon: c.drawginmode,
          iconActive: c.drawginmodeActive,
          localizedName: window.t('Stay in Drawing Mode'),
        },
        eraser: { icon: c.eraser, localizedName: window.t('Eraser') },
        group: { icon: c.group, localizedName: window.t('Show Hidden Tools') },
        hideAllDrawings: {
        ...
        zoom: { icon: c.zoom, localizedName: window.t('Zoom In') },
        'zoom-out': {
          icon: c['zoom-out'],
      ...
      return t.widget('ui.slider', t.ui.mouse, {
        ...
        _mouseDrag: function(t) {
          var e = { x: t.pageX, y: t.pageY },
            o = this._normValueFromMouse(e);
          return this._slide(t, this._handleIndex, o), !1;
        },
        ...
        _uiHash: function(t, e, o) {
          ...
          return (
            this._hasMultipleValues() &&
              ((i.value = void 0 !== e ? e : this.values(t)),
              (i.values = o || this.values())),
            i
          );
        },
        ...
        _slide: function(t, e, o) {
          ...
          this._hasMultipleValues() &&
            ...
            2 === this.options.values.length &&
              ...
              (o = 0 === e ? Math.min(i, o) : Math.max(i, o)),
            (s[e] = o)),
            o !== n &&
              !1 !== this._trigger('slide', t, this._uiHash(e, o, s)) &&
              (this._hasMultipleValues() ? this.values(e, o) : this.value(o));
        },
        _stop: function(t, e) {
        ...
        values: function(e, o) {
          ...
          if (arguments.length > 1)
            return (
              (this.options.values[e] = this._trimAlignValue(o)),
              this._refreshValue(),
          ...
          for (
            i = this.options.values, n = arguments[0], s = 0;
            s < i.length;
            s += 1
          )
          ...
          switch (
            ...
            case 'orientation':
              this._detectOrientation(),
                ...
                this._refreshValue(),
                this.options.range && this._refreshRange(o),
                this.handles.css('horizontal' === o ? 'bottom' : 'left', '');
              break;
            case 'value':
              (this._animateOff = !0),
                this._refreshValue(),
        ...
        _values: function(t) {
          ...
          if (this._hasMultipleValues()) {
            for (o = this.options.values.slice(), i = 0; i < o.length; i += 1)
              o[i] = this._trimAlignValue(o[i]);
            return o;
          }
          return [];
        },
        _trimAlignValue: function(t) {
          ...
          var e = this.options.step > 0 ? this.options.step : 1,
            o = (t - this._valueMin()) % e,
            i = t - o;
          return (
            2 * Math.abs(o) >= e && (i += o > 0 ? e : -e),
        ...
        _calculateNewMax: function() {
          var t = this.options.max,
            e = this._valueMin(),
            o = this.options.step;
          (t = Math.round((t - e) / o) * o + e),
            t > this.options.max && (t -= o),
          ...
          this._hasMultipleValues()
            ...
            : ((i = this.value()),
              ...
              (h['horizontal' === this.orientation ? 'left' : 'bottom'] =
                o + '%'),
              this.handle.stop(1, 1)[c ? 'animate' : 'css'](h, l.animate),
              'min' === r &&
                'horizontal' === this.orientation &&
                this.range
                  .stop(1, 1)
                  [c ? 'animate' : 'css']({ width: o + '%' }, l.animate),
              'max' === r &&
                'horizontal' === this.orientation &&
                this.range
                  .stop(1, 1)
                  [c ? 'animate' : 'css']({ width: 100 - o + '%' }, l.animate),
              'min' === r &&
                'vertical' === this.orientation &&
                this.range
                  .stop(1, 1)
                  [c ? 'animate' : 'css']({ height: o + '%' }, l.animate),
              'max' === r &&
                'vertical' === this.orientation &&
                this.range
                  .stop(1, 1)
        ...
        _handleEvents: {
            ...
            switch (
              ...
              case t.ui.keyCode.PAGE_UP:
                i = this._trimAlignValue(
                  o + (this._valueMax() - this._valueMin()) / this.numPages
                );
                break;
              case t.ui.keyCode.PAGE_DOWN:
                i = this._trimAlignValue(
          ...
          keyup: function(e) {
            var o = t(e.target).data('ui-slider-handle-index');
            this._keySliding &&
              ((this._keySliding = !1),
              this._stop(e, o),
              this._change(e, o),
  ...
  875: function(t, e, o) {
    'use strict';
    Object.defineProperty(e, '__esModule', { value: !0 }),
      o.d(e, 'lineToolsIcons', function() {
        return i;
      });
    var i = {
      LineTool5PointsPattern: o(886),
      LineToolABCD: o(887),
      LineToolArc: o(888),
      LineToolArrow: o(889),
      LineToolArrowMarkDown: o(890),
      LineToolArrowMarkLeft: o(891),
      LineToolArrowMarkRight: o(892),
      LineToolArrowMarkUp: o(893),
      LineToolBalloon: o(894),
      LineToolBarsPattern: o(895),
      LineToolBezierCubic: o(896),
      LineToolBezierQuadro: o(897),
      LineToolBrush: o(898),
      LineToolCallout: o(899),
      LineToolCircleLines: o(900),
      LineToolCypherPattern: o(901),
      LineToolDateAndPriceRange: o(902),
      LineToolDateRange: o(903),
      LineToolDisjointAngle: o(904),
      LineToolElliottCorrection: o(905),
      LineToolElliottDoubleCombo: o(906),
      LineToolElliottImpulse: o(907),
      LineToolElliottTriangle: o(908),
      LineToolElliottTripleCombo: o(909),
      LineToolEllipse: o(910),
      LineToolExtended: o(911),
      LineToolFibChannel: o(912),
      LineToolFibCircles: o(913),
      LineToolFibRetracement: o(914),
      LineToolFibSpeedResistanceArcs: o(915),
      LineToolFibSpeedResistanceFan: o(916),
      LineToolFibSpiral: o(917),
      LineToolFibTimeZone: o(918),
      LineToolFibWedge: o(919),
      LineToolFlagMark: o(920),
      LineToolFlatBottom: o(921),
      LineToolGannComplex: o(922),
      LineToolGannFixed: o(923),
      LineToolGannFan: o(924),
      LineToolGannSquare: o(925),
      LineToolGhostFeed: o(926),
      LineToolHeadAndShoulders: o(927),
      LineToolHorzLine: o(928),
      LineToolHorzRay: o(929),
      LineToolIcon: 'icon',
      LineToolInsidePitchfork: o(930),
      LineToolNote: o(931),
      LineToolNoteAbsolute: o(932),
      LineToolParallelChannel: o(933),
      LineToolPitchfan: o(934),
      LineToolPitchfork: o(935),
      LineToolPolyline: o(936),
      LineToolPrediction: o(937),
      LineToolPriceLabel: o(938),
      LineToolPriceRange: o(939),
      LineToolProjection: o(940),
      LineToolRay: o(941),
      LineToolRectangle: o(942),
      LineToolRegressionTrend: o(943),
      LineToolRiskRewardLong: o(944),
      LineToolRiskRewardShort: o(945),
      LineToolRotatedRectangle: o(946),
      LineToolSchiffPitchfork: o(947),
      LineToolSchiffPitchfork2: o(948),
      LineToolSineLine: o(949),
      LineToolText: o(950),
      LineToolTextAbsolute: o(951),
      LineToolThreeDrivers: o(952),
      LineToolTimeCycles: o(953),
      LineToolTrendAngle: o(954),
      LineToolTrendBasedFibExtension: o(955),
      LineToolTrendBasedFibTime: o(956),
      LineToolTrendLine: o(957),
      LineToolInfoLine: o(958),
      LineToolTriangle: o(959),
      LineToolTrianglePattern: o(960),
      LineToolVertLine: o(961),
      LineToolCrossLine: o(962),
    };
  },
  876: function(t, e) {},
  885: function(t, e) {
  ...
  964: function(t, e, o) {
    ...
    (function(e) {
      function i(t, o, i) {
        ...
        (this._toolName = t),
          (this._applyTemplate = o),
          (this._options = $.extend(n, i || {})),
          (this._list = []),
          e.enabled('charting_library_base') ||
            (this.templatesDeferred = this.loadData());
      }
      var n = o(847).bindPopupMenu,
        s = o(196),
        r = s.SaveRenameDialog,
        l = s.InputField,
        a = o(82).createConfirmDialog,
        c = o(4).getLogger('Chart.LineToolTemplatesList');
      (i._cache = {}),
        ...
        (i.prototype.loadData = function() {
          var t = this;
          return this._toolName in i._cache
            ? ((this._list = i._cache[this._toolName]), $.Deferred().resolve())
            : $.get('/drawing-templates/' + this._toolName + '/', function(e) {
                (t._list = e), (i._cache[t._toolName] = e);
              }).error(function() {
                c.logWarn('Failed to load drawing template: ' + t._toolName);
              });
        }),
        (i.prototype.templatesLoaded = function() {
          return this.templatesDeferred;
        }),
        (i.prototype.invalidateToolCache = function() {
          delete i._cache[this._toolName];
        }),
        (i.prototype.createButton = function(t) {
          var e,
            o = this;
          return (
            (t = $.extend({}, t, o._options)),
            (e = $('<a></span></a>')
              ...
              e.stopPropagation(),
                $(this).is('active') ||
                  ...
                  'function' == typeof t.getDataForSaveAs &&
                    ((n = function(e) {
                      var i = JSON.stringify(t.getDataForSaveAs());
                      o.saveTemplate(e, i);
                    }),
                    i.push({
                      title: t.saveAsText,
                      action: o.showSaveDialog.bind(o, n),
                      addClass: 'special',
                    })),
                  ...
                  (s = []),
                  $.each(o._list, function(e, i) {
                    s.push({
                      title: i,
                      action: function() {
                        o.loadTemplate.call(o, i, t.loadTemplateCallback);
                      },
                      deleteAction: function() {
                        runOrSignIn(
                          function() {
                            ...
                            a({ type: 'modal', content: t }).then(function(t) {
                              t.on('action:yes', function(t) {
                                o.removeTemplate.call(o, i), t.close();
                              }),
                                t.open();
                            });
                          },
        ...
        (i.prototype.loadTemplate = function(t, e) {
          var o = this;
          return $.get(
            '/drawing-template/' +
              this._toolName +
            ...
            function(t) {
              o._applyTemplate(JSON.parse(t.content)), e && e();
            }
          ).error(function(t) {
            c.logWarn(t.responseText);
          });
        }),
        (i.prototype.removeTemplate = function(t) {
          if (t) {
            var e = this;
        ...
        (i.prototype.saveTemplate = function(t, e) {
          var o,
            i = this;
          t &&
            e &&
            ((t = TradingView.clean(t)),
            (o = -1 !== $.inArray(t, i._list)),
            (function() {
              var n = { name: t, tool: i._toolName, content: e },
                s = function() {
                  o || i._list.push(t);
                };
              $.post('/save-drawing-template/', n, s).error(function(t) {
                c.logWarn(t.responseText);
              }),
                i.invalidateToolCache();
            })());
        }),
        (i.prototype.deleteAction = function(t) {
          var e = t,
            o = this;
          runOrSignIn(
            function() {
              ...
              a({ type: 'modal', content: t }).then(function(t) {
                t.on('action:yes', function(t) {
                  o.removeTemplate.call(o, e), t.close();
                }),
                  t.open();
              });
            },
        ...
        (i.prototype.showSaveDialog = function(t) {
          var e = this,
            o = 'text',
            i = function(t) {
              return TradingView.clean(t[o]);
            },
            n = new r({
              fields: [
                new l({
