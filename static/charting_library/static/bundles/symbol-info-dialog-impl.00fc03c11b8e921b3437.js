webpackJsonp([13], {
          ...
          (e.prototype._onResize = function() {
            ...
            o !== r.left && (this._dialog.style.left = o + 'px'),
              ...
              (this._dialog.style.height =
                n < r.height ? n + 'px' : this._initialHeight);
          }),
          e
        );
      })(),
        ...
        return (
          ...
          (t.prototype.componentDidMount = function() {
            if (this._dialog) {
              ...
              e && (this._drag = new p(this._dialog, e)),
  ...
  359: function(e, t, n) {
    ...
    (function(e, i) {
      ...
      function d(e) {
        w ||
          ((w = document.createElement('div')), document.body.appendChild(w)),
        ...
        for (n = 0; n < t.length; n++)
          (i = t[n].propName) in e &&
            ...
            'minmove2' === i && e.minmove2 > 0 && !e.fractional && e.pricescale
              ? ((t[n].value = new b(e.pricescale / r).format(
                  r / e.pricescale
                )),
      ...
      function m(e, t) {
        ...
        for (n = 0; n < t.length; n++)
          (i = t[n]),
            void 0 === i.visibility || i.visibility(e) || (t.splice(n, 1), n--);
      }
      function f(e) {
        var t, n;
        return (
    ...
    (function(e) {
      !(function(t, n) {
        ...
        function E(e, n) {
          return function(i) {
            return null != i
              ? (x(this, e, i), t.updateOffset(this, n), this)
              : C(this, e);
          };
        }
        function C(e, t) {
        ...
        function W(e, t) {
          ...
          else if (((e = k(e)), 'function' == typeof this[e]))
            return this[e](t);
          return this;
        }
        function H(e, t, n) {
          ...
          for (r = N(e._f, e._locale).match(ji) || [], n = 0; n < r.length; n++)
            (o = r[n]),
              ...
              i &&
                ...
                (d += i.length)),
              Vi[o]
                ? (i ? (c(e).empty = !1) : c(e).unusedTokens.push(o),
                  Z(o, i, e))
          ...
          return (
            ...
            null === t || (void 0 === n && '' === t)
              ...
              : ('string' == typeof t && (e._i = t = e._locale.preparse(t)),
                p(t)
                  ? new f(ee(t))
                  : (r(n) ? Se(e) : n ? Le(e) : o(t) ? (e._d = t) : Oe(e), e))
          );
        }
        function Oe(e) {
          var n = e._i;
          ...
          var n = e || Ce(),
            ...
            o =
              r < -6
                ...
                : 'sameElse';
          return this.format(
            (t && t[o]) || this.localeData().calendar(o, this, Ce(n))
          );
        }
        function ot() {
          return new f(this);
        ...
        function Gt(e) {
          ...
          return null != e
            ? ((e = $t(e, this.localeData())), this.add(e - t, 'd'))
            : t;
        }
        function jt(e) {
        ...
        for (
          P('M', ['MM', 2], 'Mo', function() {
            ...
            $n = 'January_February_March_April_May_June_July_August_September_October_November_December'.split(
              '_'
            ),
  ...
  968: function(e, t, n) {
    ...
    function r(e) {
      return a.createElement(
        'div',
        { className: c.footer, ref: e.reference },
        e.children
      );
    }
    function o(e) {
      return a.createElement(
        'div',
        { className: _.body, ref: e.reference },
        e.children
      );
    }
    function s(e) {
