webpackJsonp([19, 2], {
  ...
  818: function(t, e, o) {
    ...
    function i(t, e, o) {
      ...
      l.css({ float: 'none', 'box-sizing': 'border-box', width: '100%' }),
        (i = null),
        (n = Object(s.createDialog)({
          title: e || window.t('Add Symbol'),
          width: 400,
          actions: [
          ...
          isClickOutFn: function(t) {
            if (i && (t.target === i[0] || i[0].contains(t.target))) return !1;
          },
        })),
        (a = Object(r.bindToInput)(l, {
          callback: function(e) {
            t(e), n.close();
          },
          onPopupOpen: function(t) {
            t.css('z-index', n.zIndex), (i = t);
          },
          onPopupClose: function() {
            i = null;
          },
        })),
        n.on('action:apply', function() {
          a.then(function(t) {
            t.acceptTypeIn();
          });
        }),
    ...
    var n, s, r;
    Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.showConfirmSymbolInputDialog = i),
      (n = o(14)),
      o.n(n),
      o(11),
      (s = o(188)),
    ...
    (function(i) {
      ...
      function s() {
        var t,
          e,
          o = h.width();
        for (d.width = o, d.height = h.height(), t = 0; t < p.length; t++)
          if (o <= d.breakpoints[p[t]]) {
            d.device !== p[t] &&
              ((e = d.device),
              (d.device = p[t]),
      ...
      Object.defineProperty(e, '__esModule', { value: !0 }),
        ...
        i.extend(d, a.default.prototype),
        s(),
        $(s),
        h.on('resize', s),
        (e.default = d),
  ...
  837: function(t, e, o) {
    ...
    (function(t) {
      ...
      var c, h, u, d, p, f, g, _, v, b, y, m, w, C;
      Object.defineProperty(e, '__esModule', { value: !0 }),
        (e.TVModal = void 0),
        (c =
          Object.assign ||
  ...
  839: function(t, e, o) {
    ...
    (function(t, i) {
      ...
      var h, u, d, p, f, g, _, v, b, y, m, w, C, k, T, x, O;
      Object.defineProperty(e, '__esModule', { value: !0 }),
                  ...
                  i = function(o) {
                    ...
                    c.type || (c.type = 'default'),
                      ...
                      'checkbox' === c.type
                        ...
                        : (e.actions[c.name] = $(
                            t.render(
                              c.template ? c.template : x[c.type] || x._default,
                              c,
                              c
                            )
                          ).appendTo(e.$actions)),
