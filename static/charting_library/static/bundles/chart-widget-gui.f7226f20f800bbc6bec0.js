webpackJsonp([1], {
    ...
    Element.prototype.matches ||
      ...
      Element.prototype.closest ||
        (Element.prototype.closest = function(t) {
          for (var e = this; e && 1 === e.nodeType; e = e.parentNode)
  ...
  814: function(t, e, i) {
    ...
    (function(t) {
      function s(t, e, i, s) {
        var n, o;
        (this._options = Object.assign({}, h, s)),
          (this._model = e),
          (this._paneWidget = t),
          ...
          n.listeners().subscribe(this, function(t) {
            this.$el.css('color', t.value());
          }),
          this.$el.css('color', n.value()),
          (o = this._chart.properties().paneProperties.legendProperties
            .showLegend),
      ...
      (s.prototype.destroy = function() {
          ...
          if (
            ...
            for (
              s = {
                ...
                o = e.orderedSources().slice(),
                r = o.indexOf(n),
                r > -1 && (o.splice(r, 1), o.push(n)),
                a = o.length - 1;
              a >= 0;
              a--
            )
                    ...
                    (s.showLegend || !u
                      ? (u || s.showStudyTitles || s.showStudyValues) &&
                        ...
                        u
                          ? this._chartHasStudies()
                            ? ((c = $(
                                '<a class="pane-legend-minbtn apply-common-tooltip apply" title="' +
                                  $.t('Hide') +
                                  '"></a>'
                              ).append($(i(1149)).attr({ class: 'expand' }))),
                              p
                                .addClass('main')
                                .append(
                                  c.on(
                          ...
                          : p.addClass('study'),
                        h.properties().visible.value() ||
                          p.addClass('disabled'),
                        this._generateItemsForRow(p, d, s),
                        this._mouseEventHandlers.push(new l(p, this, !0)))
                      : this.$el.find('.expand-line').length ||
                        ...
                        this._chartHasStudies()
                          ? ((c = $(
                              ...
                              $(i(1148)).attr({ class: 'expand closed' })
                            )),
                            p.append(
                              c.on(
                                'click touchend',
        ...
        (s.prototype._generateItemsForRow = function(e, s, n) {
          ...
          if (
            (((y && n.showSeriesTitle) || (!y && n.showStudyTitles)) &&
              ...
              r.appendTo(e),
              this._itemsBinding.push({ value: s, cell: r, source: e.source }),
              !this._chart.readOnly() &&
                ...
                !y &&
                  ...
                  $(
                    ...
                    .append($(i(1150)).attr({ width: 14, height: 14 }))
                    .appendTo(o)
                    .on(
                      'click touchend',
                ...
                !y &&
                  ...
                  $(
                    ...
                    .append($(i(1151)).attr({ width: 14, height: 14 }))
                    .appendTo(o)
                    .on(
                      'click touchend',
            ...
            (l = g.legendView()),
            this.isDataWindowValuesVisible(l) && l.isValuesVisible())
          ) {
            for (
              h = [],
                d = [],
                u = $('<div class="pane-legend-item-value-container">'),
                this._options.contextMenuEnabled ||
              ...
              (c = $("<span class='pane-legend-item-value-wrap'>").appendTo(u)),
                (_ = y
                  ? $(
                      "<span class='pane-legend-item-value-title pane-legend-line'>"
                    ).appendTo(c)
                  : null),
                (v = $(
                  "<span class='pane-legend-item-value pane-legend-line'>"
                ).appendTo(c)),
                y &&
                ...
                _ && d.push(_);
            (m = $(
              "<span class='pane-legend-item-additional pane-legend-line'>"
            ).appendTo(u.appendTo(e))),
        ...
        (s.prototype._generateItemsForRow._onAddChildSourceClick = function(t) {
          ...
          s &&
            ...
            (i = this._model.model().studyInserted()),
            i.subscribe(this, e),
          ...
          for (s = this._itemsBinding.length; s--; )
            (i = this._itemsBinding[s]),
              Array.isArray(i.cell) ||
                ...
                (n = i.last),
                (o = i.source),
                (e = o.properties().visible.value()),
                this.valueChanged(n, 'sourceVisible', e) &&
                  this.setItemEnabled(i.cell, e),
                (r = i.value.color()),
                (a =
                  o !== this._model.mainSeries() &&
                  o === this._model.selectedSource()
                    ? 'bold'
                    : 'normal'),
                'function' == typeof i.value.getSplitTitle
                  ? ((u = i.value.getSplitTitle()),
                    (l = u[0].trim()),
                    (h = u[1].trim()),
                    (d = u[2].trim()))
                  : ((l = i.value.text().trim()), (h = ''), (d = '')),
                t.enabled('fundamental_widget') &&
                  ((p = this._model.mainSeries()),
                  (c = p.symbolInfo()),
                  (l = (c ? c.name : p.actualSymbol()) + ' ' + l)),
                i.isCellInited ||
                  ((i.isCellInited = !0),
                  d || h
                    ...
                    : ((i.titleElement = i.cell[0]),
                      (i.descriptionElement = i.titleElement),
                      i.descriptionElement.classList.add(
                        'apply-overflow-tooltip'
                      ))),
                (this.valueChanged(n, 'color', r) ||
                  ...
                  (i.titleElement.style.fontWeight = a)),
                l !== i.description &&
        ...
        (s.prototype.update = function(t) {
          ...
          for (this.updateTitle(), h = this._itemsBinding.length; h--; )
            if (
              ((n = this._itemsBinding[h]),
              (e = n.cell),
              (i = n.titleCells),
              (s = n.source.properties().visible.value()),
              Array.isArray(e))
            )
              for (
                n.last ||
                  ((n.last = {}), n.last.dwView || (n.last.dwView = {})),
                  d = n.last,
                  r = n.value.items(),
                  u = this.valueChanged(d, 'sourceVisible', s),
                  a = 0;
                a < e.length;
                a++
              )
                (l = r[a]),
                  ...
                  this.valueChanged(d[a], 'text', l.text()) &&
                    (e[a][0].textContent = l.text()),
                  e[a][0].classList.toggle('js-hidden', !p),
                  l.color() &&
                    this.valueChanged(d[a], 'color', l.color()) &&
                    e[a].css('color', o.resetTransparency(l.color())),
                  i &&
                    (this.valueChanged(d[a], 'sourceVisible', s) &&
                      this.setItemEnabled(i[a], s),
                    this.valueChanged(d[a], 'title', l.title()) &&
                      (i[a][0].textContent = l.title()),
                    i[a][0].classList.toggle('js-hidden', !p));
          this._chart.resizeIndicator();
        }),
        ...
        (s.prototype.renderTo = function(t, e, i) {
          ...
          for (
            ...
            (o = this._itemsBinding[n]),
              (r = o.value),
              (a = o.source === this._model.mainSeries()),
              (l = a ? 12 : 8),
              (h = a ? 25 : 17),
              Array.isArray(o.cell) ||
                ((t.font = r.size() + ' Verdana, Arial'),
                t.fillText(r.text(), e, i + s + l),
                (s += h));
          t.restore();
        }),
      ...
      if (l) {
        ...
        if (
          ...
          this.jqDiv.toggleClass(
            'toppane',
            0 === s || this._chart.isMaximizedPane()
          ),
          (n = !1),
  ...
  817: function(t, e, i) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (B =
        ...
        window.t('Reset to Default Settings') +
        '" data-tooltip-hotkey="' +
        w +
        '">\n\t\t\t' +
        p +
        ...
        return (
          ...
          (t.prototype.updatePosition = function(t) {
            null !== this._widget &&
              ...
              this._updateBtnGroupVisibility(t);
          }),
          (t.prototype._init = function() {
            var t,
              ...
              s = this;
            if (
              ((this._widget = Object(r.a)(B).querySelector(
                '.control-bar-wrapper'
              )),
              (this._back = Object(r.a)(C).querySelector(
            ...
            (this._buttons = {
              ...
              this._chart.withModel(this, function() {
                (s._chartModel = s._chart.model()),
                  (s._priceAxisChanged = s._chart.getPriceAxisWidthChangedByName(
                    s._priceAxisName
                  )),
                  ...
                  s._resetAvailabilityChanged.subscribe(
                    s,
                    s._updateResetScalesButtonVisibility
                  ),
                  s._updateBackBtnPosition(),
                  null !== s._back &&
                    s._back.addEventListener('click', function() {
                      null !== s._chartModel &&
                        s._chartModel.timeScale().scrollToRealtime(!0);
                    }),
                  ...
                  null !== s._chartBackgroundProperty &&
                    s._chartBackgroundProperty.subscribe(
                      s,
                      s._updateBgBarStyle
                    ),
                  s._updateBgBarStyle();
              ...
              for (i = 0, s = e; i < s.length; i++)
                (n = s[i]),
                  ...
                  void 0 !== (r = this._getBtnGroup(n.className)) &&
                    ...
                    (r.classList.toggle('js-hidden', o),
                    this._updateControlBarPosition());
          }),
          ...
          (t.prototype._moveByBar = function(t) {
            ...
            if (null !== this._chartModel) {
              ...
              'stop' === this._state &&
                ...
                null !== e.visibleBars() &&
                  ((i =
                    e.indexToCoordinate(e.visibleBars().lastBar()) +
                    e.barSpacing() / 2),
