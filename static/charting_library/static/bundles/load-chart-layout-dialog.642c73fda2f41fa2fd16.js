webpackJsonp([10, 2], {
    ...
    (i.prototype.onInput = function(t) {
      ...
      (i.prototype.search = function() {
        ...
        for (t = 0; t < this.items.length; t++)
          (e = this.items[t]), this.match(e) && n.push(e);
  ...
  1100: function(t, e, n) {
    ...
    (i.prototype.getPredicate = function() {
      ...
      (i.prototype.setIsAscending = function(t) {
        return (
          'boolean' == typeof t && (this.isAscending = t), this.isAscending
        );
      }),
      ...
      (a =
        ...
        (s.prototype.setSort = function(t, e) {
          var n,
            ...
            o = {
              field:
                TVSettings.getValue('loadChartDialog.sort.field') || 'modified',
              isAscending:
                TVSettings.getValue('loadChartDialog.sort.asc') || '0',
            },
            s = t || o.field,
          ...
          (this.currentSortObj && !(n = s !== o.field)) ||
            ...
            r !== o.isAscending &&
              TVSettings.setValue('loadChartDialog.sort.asc', r),
            (i = this),
            $.each(
              this.header.children(
                '.tv-load-chart-dialog-table__column--header'
              ),
              function() {
                var t = $(this),
                  e = t.data('sort') === s;
                t.removeClass('i-active i-dropped'),
                  e &&
                    t.addClass(
                      'i-active ' +
                        (i.currentSortObj.isAscending ? '' : 'i-dropped')
                    );
              }
            );
        }),
        ...
        (s.prototype.showMoreData = function() {
          ...
          if (!(this.offset >= this.matchedItems.length)) {
            for (
              t = Math.min(this.offset + d, this.matchedItems.length),
                e = '',
                n = this.offset;
              n < t;
              ++n
            ...
            this.itemsList[0].insertAdjacentHTML('beforeend', e),
              (this.offset += d);
          }
        }),
        (s.prototype.fillList = function() {
          this.sortList(),
            ...
            this.showMoreData(),
            this.itemsListContainer.toggleClass(
              'i-empty',
              0 === this.itemsData.length
            ),
        ...
        (s.prototype.updateChartsAndFavoritesData = function(t, e) {
          (this.favorites = e),
            this.itemsList &&
              ((this.itemsData = t), this.qs.setItems(t), this.qs.search());
        }),
        ...
        (s.prototype.show = function(t, e) {
          ...
          s.append(o.$control),
            ...
            (this.content = $('<div>').appendTo(
              s.find('.tv-load-chart-dialog-table')
            )),
            ...
            (this.itemsList = $(
              '<div class="tv-load-chart-dialog-table__items-list">'
    ...
    (function(t) {
      !(function(e, n) {
        ...
        function C(t, n) {
          return function(i) {
            return null != i
              ? (x(this, t, i), e.updateOffset(this, n), this)
              : O(this, t);
          };
        }
        function O(t, e) {
        ...
        function H(t, e) {
          ...
          else if (((t = L(t)), 'function' == typeof this[t]))
            return this[t](e);
          return this;
        }
        function j(t, e, n) {
        ...
        function P(t) {
          ...
          for (e = 0, n = i.length; e < n; e++)
            Ni[i[e]] ? (i[e] = Ni[i[e]]) : (i[e] = A(i[e]));
          return function(o) {
            var s = '';
            for (e = 0; e < n; e++)
              s += i[e] instanceof Function ? i[e].call(o, t) : i[e];
            return s;
          };
        }
        function F(t, e) {
          ...
          for (o = I(t._f, t._locale).match(Gi) || [], n = 0; n < o.length; n++)
            (s = o[n]),
              ...
              i &&
                ...
                (d += i.length)),
              Ni[s]
                ? (i ? (u(t).empty = !1) : u(t).unusedTokens.push(s),
                  J(s, i, t))
          ...
          return (
            ...
            null === e || (void 0 === n && '' === e)
              ...
              : ('string' == typeof e && (t._i = e = t._locale.preparse(e)),
                m(e)
                  ? new p(tt(e))
                  : (o(n) ? Tt(t) : n ? Dt(t) : s(e) ? (t._d = e) : Yt(t), t))
          );
        }
        function Yt(t) {
          var n = t._i;
        ...
        function Jt(t) {
          return (
            (t = t ? Ot(t).utcOffset() : 0), (this.utcOffset() - t) % 60 == 0
          );
        }
        function Nt() {
          return (
            ...
            : ((t = {}),
              ...
              t._a
                ? ((e = t._isUTC ? d(t._a) : Ot(t._a)),
                  (this._isDSTShifted =
                    this.isValid() && v(t._a, e.toArray()) > 0))
          ...
          var n = t || Ot(),
            ...
            s =
              o < -6
                ...
                : 'sameElse';
          return this.format(
            (e && e[s]) || this.localeData().calendar(s, this, Ot(n))
          );
        }
        function se() {
          return new p(this);
        ...
        function Ue(t) {
          ...
          return null != t
            ? ((t = Fe(t, this.localeData())), this.add(t - e, 'd'))
            : e;
        }
        function Ge(t) {
        ...
        var An,
          ...
          Bi = {},
          Ui = {},
          Gi = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g,
        ...
        for (
          W('M', ['MM', 2], 'Mo', function() {
            ...
            En = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
            Bn = [
              ...
              : !t &&
                ...
                d.data('wasScroll') &&
                  ...
                  e.scrollHeight <= e.clientHeight &&
                    (n -= h.getScrollbarWidth()),
                  d
                    .css('padding-right', (n < 0 ? 0 : n) + 'px')
    ...
    (function(t) {
      function i(e, n, i) {
        ...
        if (
          ...
          (this._touch =
            Modernizr.touch || navigator.msMaxTouchPoints || (r && a)),
          this._touch)
        )
          return (
        ...
        this._$wrapper.css('overflow', 'hidden'),
          this._$wrapper
            .on('mouseenter.sidebar-scroll', function() {
              c._bottomFixed ||
                c._dragging ||
                (c._options.alwaysVisible || c._$scrollBar.addClass('active'),
                c._onScroll());
            })
            .on('mouseleave.sidebar-scroll', function() {
              c._bottomFixed ||
                c._dragging ||
                (c._options.alwaysVisible ||
                  c._$scrollBar.removeClass('active'),
                c._onScroll());
            })
            .on('mousewheel.sidebar-scroll', function(t, e) {
              if (!t.isDefaultPrevented())
                return c.scroll(
                  e,
                  'MozMousePixelScroll' === t.originalEvent.type ? 2 : null
                );
            }),
          ...
          !1 !== this._options.showBottomShadow &&
            (this._$shadowBottom = $('<div class="sb-inner-shadow">').appendTo(
              this._$wrapper
            )),
          this._$shadowTop &&
            this._header_height &&
          ...
          (l = this._options.additionalClass
                  ...
                  i = function(n) {
                    ...
                    d.type || (d.type = 'default'),
                      ...
                      'checkbox' === d.type
                        ...
                        : (e.actions[d.name] = $(
                            t.render(
                              d.template ? d.template : k[d.type] || k._default,
                              d,
                              d
                            )
                          ).appendTo(e.$actions)),
            ...
            u(n, [
              {
                ...
                value: function(t) {
                  return (
                    this.$contentIn.html('function' == typeof t ? t(this) : t),
                    this
                  );
                },
              },
                      ...
                      i.get(0) !== this.$el.get(0) &&
                        ($('>*', this.$el).each(function() {
                          i.get(0) === $(this).get(0) && (n = !1),
                            0 === i.closest('HTML', $(this).get(0)).length &&
                              (n = !1);
                        }),
                        n));
                },
                  ...
                  b && b !== this && b.unfocus(),
                    ...
                    setTimeout(function() {
                      w.on('mousedown.tv-dialog-unfocus-' + t._id, function(e) {
                        t.isEventOut(e) &&
                          (t.unfocus(),
                          w.off('mousedown.tv-dialog-unfocus-' + t._id));
                      });
                    }, 20);
                },
              },
                ...
                value: function(t, e) {
                  return (
                    !e && this.disabledActions.includes(t)
                      ...
                      : e &&
                        this.disabledActions.includes(t) &&
                        (this.disabledActions = i.without(
  ...
  840: function(t, e, n) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (a = n(184)),
      (l = i(a)),
      ($.fn.tvButtonLoader = (0, r.createTvBlockWithInstance)(
        'tv-button-loader',
        function(t, e) {
          return new d(t, e);
        }
      )),
      (d = e.ButtonLoader = (function() {
        function t(e, n) {
          o(this, t),
      ...
      (e.TVPopup = (function(t) {
        function e() {
          ...
          return (
            ...
            (t = r(
              this,
              (e.__proto__ || Object.getPrototypeOf(e)).call(this, l({}, v, n))
            )),
            (t.$scrollWrap = t.$content.hasClass(b)
              ? t.$content
              : t.$content.find('.' + b)),
            t.$scrollWrap.length
            ...
            t.options.withScroll &&
              ((t.scroll = new p.SidebarCustomScroll(
                t.$scrollWrap,
                t.$scrollWrapInner
              )),
            ...
            },
            {
              ...
              value: function() {
                ...
                t.bottom > _.default.height - 10 &&
                  ((e.top = _.default.height - 10 - t.height),
                  e.top < 10 && (e.top = 10)),
                  t.right > _.default.width - 10 &&
                    ((e.left = _.default.width - 10 - t.width),
                    e.left < 10 && (e.left = 10)),
            ...
            },
            {
              ...
              value: function() {
                var t,
                  ...
                  s =
                    this.options.height &&
                    this.options.height < _.default.height - 20
                      ? this.options.height
                      : _.default.height - 20;
                this.$scrollWrap
                  .css({ height: '' })
    ...
    window.language &&
      (i.locale(window.language, {
        ...
        relativeTime: {
          ...
          s: $.t('just now'),
          m: function(t) {
            return $.t('%d minute', { plural: '%d minutes', count: t }).replace(
              '%d',
              t
            );
          },
          ...
          h: $.t('an hour'),
          hh: function(t) {
            return $.t('%d hour', { plural: '%d hours', count: t }).replace(
              '%d',
              t
            );
          },
          d: $.t('a day'),
          dd: function(t) {
            return $.t('%d day', { plural: '%d days', count: t }).replace(
              '%d',
              t
            );
          },
          M: $.t('a month'),
          MM: function(t) {
            return $.t('%d month', { plural: '%d months', count: t }).replace(
              '%d',
              t
            );
          },
          y: $.t('a year'),
          yy: function(t) {
            return $.t('%d year', { plural: '%d years', count: t }).replace(
              '%d',
              t
            );
          },
